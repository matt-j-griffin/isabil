...
interpretation step_cast_lowI: exp_val_word_sz_syntax \<open>\<lambda>e _ _ _. (\<And>\<Delta> sz. \<Delta> \<turnstile> low:sz[e] \<leadsto> ext e \<sim> hi : sz - 1 \<sim> lo : 0)\<close>
  by (standard, rule step_cast_lowI)
...
interpretation step_cast_highI: exp_val_word_sz_syntax \<open>\<lambda>e _ _ sz'. (\<And>\<Delta> sz. \<Delta> \<turnstile> high:sz[e] \<leadsto> ext e \<sim> hi : sz' - 1 \<sim> lo : sz' - sz)\<close>
  by (standard, rule step_cast_highI)
...
interpretation step_cast_signedI: exp_val_word_sz_syntax \<open>\<lambda>e _ _ _. (\<And>\<Delta> sz. \<Delta> \<turnstile> extend:sz[e] \<leadsto> ext e \<sim> hi : sz - 1 \<sim> lo : 0)\<close>
  by (standard, rule step_cast_signedI)
...
interpretation step_cast_unsignedI: exp_val_word_sz_syntax \<open>\<lambda>e _ _ _. (\<And>\<Delta> sz. \<Delta> \<turnstile> pad:sz[e] \<leadsto> ext e \<sim> hi : sz - 1 \<sim> lo : 0)\<close>
  by (standard, rule step_cast_unsignedI)
...
method solve_expI uses simp = (((unfold simp)?), (
  ...
  rule step_load_byteI.word.word | rule step_load_byteI.word.true | rule step_load_byteI.word.false | 
  rule step_load_byteI.word.storage | 
  rule step_load_byteI.word.unknown | rule step_load_byteI.word.xtract |
  rule step_load_byteI.word.succ | rule step_load_byteI.word.succ2 | rule step_load_byteI.word.succ3 | 
  rule step_load_byteI.word.succ4 | rule step_load_byteI.word.succ5 | rule step_load_byteI.word.succ6 | 
  rule step_load_byteI.word.succ7 |
  rule step_load_byteI.word.val |

  rule step_load_byteI.succ.word | rule step_load_byteI.succ.true | rule step_load_byteI.succ.false | 
  rule step_load_byteI.succ.storage | 
  rule step_load_byteI.succ.unknown | rule step_load_byteI.succ.xtract |
  rule step_load_byteI.succ.succ | rule step_load_byteI.succ.succ2 | rule step_load_byteI.succ.succ3 | 
  rule step_load_byteI.succ.succ4 | rule step_load_byteI.succ.succ5 | rule step_load_byteI.succ.succ6 | 
  rule step_load_byteI.succ.succ7 |
  rule step_load_byteI.succ.val |

  rule step_load_byteI.succ2.word | rule step_load_byteI.succ2.true | rule step_load_byteI.succ2.false | 
  rule step_load_byteI.succ2.storage |
  rule step_load_byteI.succ2.unknown | rule step_load_byteI.succ2.xtract |
  rule step_load_byteI.succ2.succ | rule step_load_byteI.succ2.succ2 | rule step_load_byteI.succ2.succ3 | 
  rule step_load_byteI.succ2.succ4 | rule step_load_byteI.succ2.succ5 | rule step_load_byteI.succ2.succ6 | 
  rule step_load_byteI.succ2.succ7 |
  rule step_load_byteI.succ2.val |

  rule step_load_byteI.succ3.word | rule step_load_byteI.succ3.true | rule step_load_byteI.succ3.false | 
  rule step_load_byteI.succ3.storage |
  rule step_load_byteI.succ3.unknown | rule step_load_byteI.succ3.xtract |
  rule step_load_byteI.succ3.succ | rule step_load_byteI.succ3.succ2 | rule step_load_byteI.succ3.succ3 | 
  rule step_load_byteI.succ3.succ4 | rule step_load_byteI.succ3.succ5 | rule step_load_byteI.succ3.succ6 | 
  rule step_load_byteI.succ3.succ7 |
  rule step_load_byteI.succ3.val |

  rule step_load_byteI.succ4.word | rule step_load_byteI.succ4.true | rule step_load_byteI.succ4.false | 
  rule step_load_byteI.succ4.storage |
  rule step_load_byteI.succ4.unknown | rule step_load_byteI.succ4.xtract |
  rule step_load_byteI.succ4.succ | rule step_load_byteI.succ4.succ2 | rule step_load_byteI.succ4.succ3 | 
  rule step_load_byteI.succ4.succ4 | rule step_load_byteI.succ4.succ5 | rule step_load_byteI.succ4.succ6 | 
  rule step_load_byteI.succ4.succ7 |
  rule step_load_byteI.succ4.val |

  rule step_load_byteI.succ5.word | rule step_load_byteI.succ5.true | rule step_load_byteI.succ5.false | 
  rule step_load_byteI.succ5.storage |
  rule step_load_byteI.succ5.unknown | rule step_load_byteI.succ5.xtract |
  rule step_load_byteI.succ5.succ | rule step_load_byteI.succ5.succ2 | rule step_load_byteI.succ5.succ3 | 
  rule step_load_byteI.succ5.succ4 | rule step_load_byteI.succ5.succ5 | rule step_load_byteI.succ5.succ6 | rule step_load_byteI.succ5.succ7 |
  rule step_load_byteI.succ5.val |

  rule step_load_byteI.succ6.word | rule step_load_byteI.succ6.true | rule step_load_byteI.succ6.false | 
  rule step_load_byteI.succ6.storage |
  rule step_load_byteI.succ6.unknown | rule step_load_byteI.succ6.xtract |
  rule step_load_byteI.succ6.succ | rule step_load_byteI.succ6.succ2 | rule step_load_byteI.succ6.succ3 | 
  rule step_load_byteI.succ6.succ4 | rule step_load_byteI.succ6.succ5 | rule step_load_byteI.succ6.succ6 | 
  rule step_load_byteI.succ6.succ7 |
  rule step_load_byteI.succ6.val |

  rule step_load_byteI.succ7.word | rule step_load_byteI.succ7.true | rule step_load_byteI.succ7.false | 
  rule step_load_byteI.succ7.storage |
  rule step_load_byteI.succ7.unknown | rule step_load_byteI.succ7.xtract |
  rule step_load_byteI.succ7.succ | rule step_load_byteI.succ7.succ2 | rule step_load_byteI.succ7.succ3 | 
  rule step_load_byteI.succ7.succ4 | rule step_load_byteI.succ7.succ5 | rule step_load_byteI.succ7.succ6 | rule step_load_byteI.succ7.succ7 |
  ...
  (rule step_load_byte_from_nextI, solve_word_neq) |


  (rule step_load_word_elI.storage.word, linarith) |
  (rule step_load_word_elI.storage.succ, linarith) |
  (rule step_load_word_elI.storage.succ2, linarith) |
  (rule step_load_word_elI.storage.succ3, linarith) |
  (rule step_load_word_elI.storage.succ4, linarith) |
  (rule step_load_word_elI.storage.succ5, linarith) |
  (rule step_load_word_elI.storage.succ6, linarith) |
  (rule step_load_word_elI.storage.succ7, linarith) |
  (rule step_load_word_elI.storage_addr.word, solve_typeI, linarith) |
  ...
  (rule step_load_word_beI.storage.word, linarith) |
  (rule step_load_word_beI.storage.succ, linarith) |
  (rule step_load_word_beI.storage.succ2, linarith) |
  (rule step_load_word_beI.storage.succ3, linarith) |
  (rule step_load_word_beI.storage.succ4, linarith) |
  (rule step_load_word_beI.storage.succ5, linarith) |
  (rule step_load_word_beI.storage.succ6, linarith) |
  (rule step_load_word_beI.storage.succ7, linarith) |
  (rule step_load_word_beI.storage_addr.word, solve_typeI, linarith) |
  (rule step_load_word_beI.storage_addr.succ, solve_typeI, linarith) |
  (rule step_load_word_beI.storage_addr.succ2, solve_typeI, linarith) |
  (rule step_load_word_beI.storage_addr.succ3, solve_typeI, linarith) |
  (rule step_load_word_beI.storage_addr.succ4, solve_typeI, linarith) |
  (rule step_load_word_beI.storage_addr.succ5, solve_typeI, linarith) |
  (rule step_load_word_beI.storage_addr.succ6, solve_typeI, linarith) |
  (rule step_load_word_beI.storage_addr.succ7, solve_typeI, linarith) |


  (rule step_load_memI.bv_plus, solve_expI simp: simp) |
  (rule step_load_addrI, solve_expI simp: simp) |

  \<comment> \<open>Store\<close>
  (rule step_store_valI.word.storage.xtract) |
  (rule step_store_valI.word.storage_addr.xtract, solve_typeI) |
  (rule step_store_valI.word.val.xtract, solve_typeI) |
  (rule step_store_valI.succ.storage.xtract) |
  (rule step_store_valI.succ.storage_addr.xtract, solve_typeI) |
  (rule step_store_valI.succ.val.xtract, solve_typeI) |
  (rule step_store_valI.succ2.storage.xtract) |
  (rule step_store_valI.succ2.storage_addr.xtract, solve_typeI) |
  (rule step_store_valI.succ2.val.xtract, solve_typeI) |
  (rule step_store_valI.succ3.storage.xtract) |
  (rule step_store_valI.succ3.storage_addr.xtract, solve_typeI) |
  (rule step_store_valI.succ3.val.xtract, solve_typeI) |
  (rule step_store_valI.succ4.storage.xtract) |
  (rule step_store_valI.succ4.storage_addr.xtract, solve_typeI) |
  (rule step_store_valI.succ4.val.xtract, solve_typeI) |
  (rule step_store_valI.succ5.storage.xtract) |
  (rule step_store_valI.succ5.storage_addr.xtract, solve_typeI) |
  (rule step_store_valI.succ5.val.xtract, solve_typeI) |
  (rule step_store_valI.succ6.storage.xtract) |
  (rule step_store_valI.succ6.storage_addr.xtract, solve_typeI) |
  (rule step_store_valI.succ6.val.xtract, solve_typeI) |
  (rule step_store_valI.succ7.storage.xtract) |
  (rule step_store_valI.succ7.storage_addr.xtract, solve_typeI) |
  (rule step_store_valI.succ7.val.xtract, solve_typeI) |

  (rule step_store_step_valI, solve_expI simp: simp) |

  \<comment> \<open>Let\<close>
  (rule step_let_stepI, solve_expI simp: simp) |

  \<comment> \<open>Ite\<close>
  (rule step_ite_elseI, solve_expI simp: simp) |

  \<comment> \<open>Bop\<close>

  \<comment> \<open>Plus\<close>
  (rule step_plusI) |
  (rule step_plusI.lhsI, solve_expI simp: simp) |
  ...
  (rule step_uopI, solve_expI simp: simp) |

  \<comment> \<open>Concat\<close>
  rule step_concatI | rule step_concatI.xtract.xtract |

  (rule step_concat_lhsI.word, solve_expI simp: simp) | 
  (rule step_concat_lhsI.xtract, solve_expI simp: simp) |

  (rule step_concat_rhsI, solve_expI simp: simp) |
  ...
  (rule step_extract_reduceI, solve_expI simp: simp) |

  \<comment> \<open>Cast\<close>
  (rule step_cast_lowI) |  (rule step_cast_lowI.xtract) |
  (rule step_cast_highI) | (rule step_cast_highI.xtract) |
  (rule step_cast_signedI) | (rule step_cast_signedI.xtract) |
  (rule step_cast_unsignedI) | (rule step_cast_unsignedI.xtract) |
  (rule step_cast_unkI) | 
  (rule step_cast_reduceI, solve_expI simp: simp)
))
