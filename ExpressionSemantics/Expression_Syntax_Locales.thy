...
locale exp_val_is_imm_syntax =
  ...
  assumes val_imm: \<open>\<And>v sz. type v = imm\<langle>sz\<rangle> \<Longrightarrow> PROP P (Val v) v sz\<close>
begin

sublocale exp_val_word_sz_syntax
  where P = \<open>\<lambda>e v _ sz. P e v sz\<close>
  apply standard
  unfolding word_constructor_exp_def by (rule val_imm[OF type_wordI])
...
locale exp2_val_word_sz_syntax =
  ...
  assumes word2: \<open>\<And>num\<^sub>1 sz\<^sub>1 num\<^sub>2 sz\<^sub>2. PROP P (num\<^sub>1 \<Colon> sz\<^sub>1) (num\<^sub>1 \<Colon> sz\<^sub>1) (num\<^sub>1 \<Colon> sz\<^sub>1) sz\<^sub>1 (num\<^sub>2 \<Colon> sz\<^sub>2) (num\<^sub>2 \<Colon> sz\<^sub>2) (num\<^sub>2 \<Colon> sz\<^sub>2) sz\<^sub>2\<close>
begin

sublocale xtract: exp_val_word_sz_syntax
  where P = \<open>\<lambda>e v w sz'. P (ext (num \<Colon> sz) \<sim> hi : sz\<^sub>1 \<sim> lo : sz\<^sub>2) (ext (num \<Colon> sz) \<sim> hi : sz\<^sub>1 \<sim> lo : sz\<^sub>2) (ext (num \<Colon> sz) \<sim> hi : sz\<^sub>1 \<sim> lo : sz\<^sub>2) (sz\<^sub>1 - sz\<^sub>2 + 1) e v w sz'\<close>
  apply (standard)
  unfolding xtract.simps by (rule word2)

sublocale word: exp_val_word_sz_syntax
  where P = \<open>\<lambda>e v w sz'. P (num \<Colon> sz) (num \<Colon> sz) (num \<Colon> sz) sz e v w sz'\<close> 
  apply (standard)
  unfolding succ.simps bv_plus.simps by (rule word2)

sublocale succ: exp_val_word_sz_syntax
  where P = \<open>\<lambda>e v w sz'. P (succ (num \<Colon> sz)) (succ (num \<Colon> sz)) (succ (num \<Colon> sz)) sz e v w sz'\<close> 
  apply (standard)
  unfolding succ.simps bv_plus.simps by (rule word2)

sublocale succ2: exp_val_word_sz_syntax
  where P = \<open>\<lambda>e v w sz'. P (succ (succ (num \<Colon> sz))) (succ (succ (num \<Colon> sz))) (succ (succ (num \<Colon> sz))) sz e v w sz'\<close>
  apply (standard)
  unfolding succ.simps bv_plus.simps by (rule word2)

sublocale succ3: exp_val_word_sz_syntax
  where P = \<open>\<lambda>e v w sz'. P (succ (succ (succ (num \<Colon> sz)))) (succ (succ (succ (num \<Colon> sz)))) (succ (succ (succ (num \<Colon> sz)))) sz e v w sz'\<close>
  apply (standard)
  unfolding succ.simps bv_plus.simps by (rule word2)

sublocale succ4: exp_val_word_sz_syntax
  where P = \<open>\<lambda>e v w sz'. P (succ (succ (succ (succ (num \<Colon> sz))))) (succ (succ (succ (succ (num \<Colon> sz))))) (succ (succ (succ (succ (num \<Colon> sz))))) sz e v w sz'\<close>
  apply (standard)
  unfolding succ.simps bv_plus.simps by (rule word2)

sublocale succ5: exp_val_word_sz_syntax
  where P = \<open>\<lambda>e v w sz'. P (succ (succ (succ (succ (succ (num \<Colon> sz)))))) (succ (succ (succ (succ (succ (num \<Colon> sz)))))) (succ (succ (succ (succ (succ (num \<Colon> sz)))))) sz e v w sz'\<close>
  apply (standard)
  unfolding succ.simps bv_plus.simps by (rule word2)

sublocale succ6: exp_val_word_sz_syntax
  where P = \<open>\<lambda>e v w sz'. P (succ (succ (succ (succ (succ (succ (num \<Colon> sz))))))) (succ (succ (succ (succ (succ (succ (num \<Colon> sz))))))) (succ (succ (succ (succ (succ (succ (num \<Colon> sz))))))) sz e v w sz'\<close>
  apply (standard)
  unfolding succ.simps bv_plus.simps by (rule word2)

sublocale succ7: exp_val_word_sz_syntax
  where P = \<open>\<lambda>e v w sz'. P (succ (succ (succ (succ (succ (succ (succ (num \<Colon> sz)))))))) (succ (succ (succ (succ (succ (succ (succ (num \<Colon> sz)))))))) (succ (succ (succ (succ (succ (succ (succ (num \<Colon> sz)))))))) sz e v w sz'\<close>
  apply (standard)
  unfolding succ.simps bv_plus.simps by (rule word2)

sublocale true: exp_val_word_sz_syntax
  where P = \<open>\<lambda>e v w sz'. P true true true 1 e v w sz'\<close>
  apply (standard)
  unfolding true_word by (rule word2)

sublocale false: exp_val_word_sz_syntax
  where P = \<open>\<lambda>e v w sz'. P false false false 1 e v w sz'\<close>
  apply (standard)
  unfolding false_word by (rule word2)

sublocale bv_plus: exp_val_word_sz_syntax
  where P = \<open>\<lambda>e v w sz'. P ((num\<^sub>1 \<Colon> sz) +\<^sub>b\<^sub>v (num\<^sub>2 \<Colon> sz)) ((num\<^sub>1 \<Colon> sz) +\<^sub>b\<^sub>v (num\<^sub>2 \<Colon> sz)) ((num\<^sub>1 \<Colon> sz) +\<^sub>b\<^sub>v (num\<^sub>2 \<Colon> sz)) sz e v w sz'\<close>
  apply (standard)
  unfolding bv_plus.simps by (rule word2)

sublocale bv_leq: exp_val_word_sz_syntax
  where P = \<open>\<lambda>e v w sz'. P ((num\<^sub>1 \<Colon> sz) \<le>\<^sub>b\<^sub>v (num\<^sub>2 \<Colon> sz)) ((num\<^sub>1 \<Colon> sz) \<le>\<^sub>b\<^sub>v (num\<^sub>2 \<Colon> sz)) ((num\<^sub>1 \<Colon> sz) \<le>\<^sub>b\<^sub>v (num\<^sub>2 \<Colon> sz)) 1 e v w sz'\<close>
  apply (standard)
  unfolding bv_leq_true_or_false by (rule word2)
...
sublocale storage_addr: exp_val_syntax
  ...
  unfolding storage_constructor_exp_def apply (standard, rule val2)
  by (rule type_storage_addrI)
...
locale store_multiple_syntax =
  ...
  assumes store_val: \<open>\<And>v sz\<^sub>a\<^sub>d\<^sub>d\<^sub>r sz\<^sub>m\<^sub>e\<^sub>m num v'. type v = mem\<langle>sz\<^sub>a\<^sub>d\<^sub>d\<^sub>r, sz\<^sub>m\<^sub>e\<^sub>m\<rangle> \<Longrightarrow> PROP P (Val v) v (num \<Colon> sz\<^sub>a\<^sub>d\<^sub>d\<^sub>r) (num \<Colon> sz\<^sub>a\<^sub>d\<^sub>d\<^sub>r) (num \<Colon> sz\<^sub>a\<^sub>d\<^sub>d\<^sub>r) (Val v') v' sz\<^sub>a\<^sub>d\<^sub>d\<^sub>r sz\<^sub>m\<^sub>e\<^sub>m\<close>
begin
...
sublocale succ4: exp2_storage_val_syntax
  where P2 = \<open>\<lambda>e\<^sub>1 e\<^sub>2 v\<^sub>1 v\<^sub>2 sz\<^sub>a\<^sub>d\<^sub>d\<^sub>r sz\<^sub>m\<^sub>e\<^sub>m. (\<And>num. PROP P e\<^sub>1 v\<^sub>1 (succ (succ (succ (succ (num \<Colon> sz\<^sub>a\<^sub>d\<^sub>d\<^sub>r))))) (succ (succ (succ (succ (num \<Colon> sz\<^sub>a\<^sub>d\<^sub>d\<^sub>r))))) (succ (succ (succ (succ (num \<Colon> sz\<^sub>a\<^sub>d\<^sub>d\<^sub>r))))) e\<^sub>2 v\<^sub>2 sz\<^sub>a\<^sub>d\<^sub>d\<^sub>r sz\<^sub>m\<^sub>e\<^sub>m)\<close>
  apply (standard)
  unfolding storage_constructor_exp_def succ.simps bv_plus.simps by (rule store_val)

sublocale succ5: exp2_storage_val_syntax
  where P2 = \<open>\<lambda>e\<^sub>1 e\<^sub>2 v\<^sub>1 v\<^sub>2 sz\<^sub>a\<^sub>d\<^sub>d\<^sub>r sz\<^sub>m\<^sub>e\<^sub>m. (\<And>num. PROP P e\<^sub>1 v\<^sub>1 (succ (succ (succ (succ (succ (num \<Colon> sz\<^sub>a\<^sub>d\<^sub>d\<^sub>r)))))) (succ (succ (succ (succ (succ (num \<Colon> sz\<^sub>a\<^sub>d\<^sub>d\<^sub>r)))))) (succ (succ (succ (succ (succ (num \<Colon> sz\<^sub>a\<^sub>d\<^sub>d\<^sub>r)))))) e\<^sub>2 v\<^sub>2 sz\<^sub>a\<^sub>d\<^sub>d\<^sub>r sz\<^sub>m\<^sub>e\<^sub>m)\<close>
  apply (standard)
  unfolding storage_constructor_exp_def succ.simps bv_plus.simps by (rule store_val)

sublocale succ6: exp2_storage_val_syntax
  where P2 = \<open>\<lambda>e\<^sub>1 e\<^sub>2 v\<^sub>1 v\<^sub>2 sz\<^sub>a\<^sub>d\<^sub>d\<^sub>r sz\<^sub>m\<^sub>e\<^sub>m. (\<And>num. PROP P e\<^sub>1 v\<^sub>1 (succ (succ (succ (succ (succ (succ (num \<Colon> sz\<^sub>a\<^sub>d\<^sub>d\<^sub>r))))))) (succ (succ (succ (succ (succ (succ (num \<Colon> sz\<^sub>a\<^sub>d\<^sub>d\<^sub>r))))))) (succ (succ (succ (succ (succ (succ (num \<Colon> sz\<^sub>a\<^sub>d\<^sub>d\<^sub>r))))))) e\<^sub>2 v\<^sub>2 sz\<^sub>a\<^sub>d\<^sub>d\<^sub>r sz\<^sub>m\<^sub>e\<^sub>m)\<close>
  apply (standard)
  unfolding storage_constructor_exp_def succ.simps bv_plus.simps by (rule store_val)

sublocale succ7: exp2_storage_val_syntax
  where P2 = \<open>\<lambda>e\<^sub>1 e\<^sub>2 v\<^sub>1 v\<^sub>2 sz\<^sub>a\<^sub>d\<^sub>d\<^sub>r sz\<^sub>m\<^sub>e\<^sub>m. (\<And>num. PROP P e\<^sub>1 v\<^sub>1 (succ (succ (succ (succ (succ (succ (succ (num \<Colon> sz\<^sub>a\<^sub>d\<^sub>d\<^sub>r)))))))) (succ (succ (succ (succ (succ (succ (succ (num \<Colon> sz\<^sub>a\<^sub>d\<^sub>d\<^sub>r)))))))) (succ (succ (succ (succ (succ (succ (succ (num \<Colon> sz\<^sub>a\<^sub>d\<^sub>d\<^sub>r)))))))) e\<^sub>2 v\<^sub>2 sz\<^sub>a\<^sub>d\<^sub>d\<^sub>r sz\<^sub>m\<^sub>e\<^sub>m)\<close>
  apply (standard)
  unfolding storage_constructor_exp_def succ.simps bv_plus.simps by (rule store_val)
...
locale store_gt8_syntax =
  ...
  assumes word_val2: \<open>\<And>v sz\<^sub>a\<^sub>d\<^sub>d\<^sub>r num num\<^sub>2. type v = mem\<langle>sz\<^sub>a\<^sub>d\<^sub>d\<^sub>r, 8\<rangle> \<Longrightarrow> PROP P (Val v) v (num \<Colon> sz\<^sub>a\<^sub>d\<^sub>d\<^sub>r) (num \<Colon> sz\<^sub>a\<^sub>d\<^sub>d\<^sub>r) sz\<^sub>a\<^sub>d\<^sub>d\<^sub>r (num\<^sub>2 \<Colon> sz\<^sub>v\<^sub>a\<^sub>l) (num\<^sub>2 \<Colon> sz\<^sub>v\<^sub>a\<^sub>l)\<close>
begin

sublocale val: exp2_val_word_sz_syntax
  where P = \<open>\<lambda>e\<^sub>1 _ w\<^sub>1 sz\<^sub>1 e\<^sub>2 v\<^sub>2 _ sz\<^sub>2. (\<And>v. sz\<^sub>2 = sz\<^sub>v\<^sub>a\<^sub>l \<Longrightarrow> type v = mem\<langle>sz\<^sub>1, 8\<rangle> \<Longrightarrow> PROP P (Val v) v e\<^sub>1 w\<^sub>1 sz\<^sub>1 e\<^sub>2 v\<^sub>2)\<close>
  apply (standard)
  unfolding storage_constructor_exp_def
  apply simp
  by (rule word_val2)

sublocale storage: exp2_val_word_sz_syntax
  where P = \<open>\<lambda>e\<^sub>1 _ w\<^sub>1 sz\<^sub>1 e\<^sub>2 v\<^sub>2 _ sz\<^sub>2. (\<And>num v v' sz\<^sub>m\<^sub>e\<^sub>m. sz\<^sub>2 = sz\<^sub>v\<^sub>a\<^sub>l \<Longrightarrow> PROP P (v[(num \<Colon> sz\<^sub>1) \<leftarrow> v', 8]) (v[(num \<Colon> sz\<^sub>1) \<leftarrow> v', 8]) e\<^sub>1 w\<^sub>1 sz\<^sub>1 e\<^sub>2 v\<^sub>2)\<close>
  apply (standard)
  unfolding storage_constructor_exp_def
  apply simp
  apply (rule word_val2)
  by (rule type_storageI)

sublocale storage_addr: exp2_val_word_sz_syntax
  where P = \<open>\<lambda>e\<^sub>1 _ w\<^sub>1 sz\<^sub>1 e\<^sub>2 v\<^sub>2 _ sz\<^sub>2. (\<And>w v v'. sz\<^sub>2 = sz\<^sub>v\<^sub>a\<^sub>l \<Longrightarrow> type w = imm\<langle>sz\<^sub>1\<rangle> \<Longrightarrow> PROP P (v[w \<leftarrow> v', 8]) (v[w \<leftarrow> v', 8]) e\<^sub>1 w\<^sub>1 sz\<^sub>1 e\<^sub>2 v\<^sub>2)\<close>
  apply (standard)
  unfolding storage_constructor_exp_def
  apply simp
  apply (rule word_val2)
...
sublocale unknown: exp2_val_word_sz_syntax
  where P = \<open>\<lambda>e\<^sub>1 _ w\<^sub>1 sz\<^sub>1 e\<^sub>2 v\<^sub>2 _ sz\<^sub>2. (\<And>str. sz\<^sub>2 = sz\<^sub>v\<^sub>a\<^sub>l \<Longrightarrow> PROP P (unknown[str]: mem\<langle>sz\<^sub>1, 8\<rangle>) (unknown[str]: mem\<langle>sz\<^sub>1, 8\<rangle>) e\<^sub>1 w\<^sub>1 sz\<^sub>1 e\<^sub>2 v\<^sub>2)\<close>
  apply (standard)
  unfolding unknown_constructor_exp_def
  apply simp
  apply (rule word_val2)
