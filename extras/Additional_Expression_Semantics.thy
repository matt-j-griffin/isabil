...
lemma refl32_load_rev_cut64I:
  assumes \<open>\<Delta> \<turnstile> mem[w' \<leftarrow> v', 8][num\<^sub>3 \<Colon> sz\<^sub>a\<^sub>d\<^sub>d\<^sub>r, el]:u64 \<leadsto>* v\<close>
      ...
      and \<open>((num\<^sub>1 \<Colon> sz\<^sub>a\<^sub>d\<^sub>d\<^sub>r)::word) \<noteq> (num\<^sub>3 \<Colon> sz\<^sub>a\<^sub>d\<^sub>d\<^sub>r)\<close> 
      and \<open>((num\<^sub>1 \<Colon> sz\<^sub>a\<^sub>d\<^sub>d\<^sub>r)::word) \<noteq> succ (num\<^sub>3 \<Colon> sz\<^sub>a\<^sub>d\<^sub>d\<^sub>r)\<close> 
      and \<open>((num\<^sub>1 \<Colon> sz\<^sub>a\<^sub>d\<^sub>d\<^sub>r)::word) \<noteq> succ (succ (num\<^sub>3 \<Colon> sz\<^sub>a\<^sub>d\<^sub>d\<^sub>r))\<close>
      and \<open>((num\<^sub>1 \<Colon> sz\<^sub>a\<^sub>d\<^sub>d\<^sub>r)::word) \<noteq> succ (succ (succ (num\<^sub>3 \<Colon> sz\<^sub>a\<^sub>d\<^sub>d\<^sub>r)))\<close>
      and \<open>((num\<^sub>1 \<Colon> sz\<^sub>a\<^sub>d\<^sub>d\<^sub>r)::word) \<noteq> succ (succ (succ (succ (num\<^sub>3 \<Colon> sz\<^sub>a\<^sub>d\<^sub>d\<^sub>r))))\<close>
      and \<open>((num\<^sub>1 \<Colon> sz\<^sub>a\<^sub>d\<^sub>d\<^sub>r)::word) \<noteq> succ (succ (succ (succ (succ (num\<^sub>3 \<Colon> sz\<^sub>a\<^sub>d\<^sub>d\<^sub>r)))))\<close>
      and \<open>((num\<^sub>1 \<Colon> sz\<^sub>a\<^sub>d\<^sub>d\<^sub>r)::word) \<noteq> succ (succ (succ (succ (succ (succ (num\<^sub>3 \<Colon> sz\<^sub>a\<^sub>d\<^sub>d\<^sub>r))))))\<close>
      and \<open>((num\<^sub>1 \<Colon> sz\<^sub>a\<^sub>d\<^sub>d\<^sub>r)::word) \<noteq> succ (succ (succ (succ (succ (succ (succ (num\<^sub>3 \<Colon> sz\<^sub>a\<^sub>d\<^sub>d\<^sub>r)))))))\<close>
      and \<open>succ ((num\<^sub>1 \<Colon> sz\<^sub>a\<^sub>d\<^sub>d\<^sub>r)::word) \<noteq> (num\<^sub>3 \<Colon> sz\<^sub>a\<^sub>d\<^sub>d\<^sub>r)\<close> 
      and \<open>succ (succ ((num\<^sub>1 \<Colon> sz\<^sub>a\<^sub>d\<^sub>d\<^sub>r)::word)) \<noteq> (num\<^sub>3 \<Colon> sz\<^sub>a\<^sub>d\<^sub>d\<^sub>r)\<close>
      and \<open>succ (succ (succ ((num\<^sub>1 \<Colon> sz\<^sub>a\<^sub>d\<^sub>d\<^sub>r)::word))) \<noteq>(num\<^sub>3 \<Colon> sz\<^sub>a\<^sub>d\<^sub>d\<^sub>r)\<close>
...
lemma refl64_load_rev_cut64I:
  assumes \<open>\<Delta> \<turnstile> mem[w' \<leftarrow> v', 8][num\<^sub>3 \<Colon> sz\<^sub>a\<^sub>d\<^sub>d\<^sub>r, el]:u64 \<leadsto>* v\<close>
      ...
      and \<open>succ (succ ((num\<^sub>1 \<Colon> sz\<^sub>a\<^sub>d\<^sub>d\<^sub>r)::word)) \<noteq> (num\<^sub>3 \<Colon> sz\<^sub>a\<^sub>d\<^sub>d\<^sub>r)\<close>
      and \<open>succ (succ (succ ((num\<^sub>1 \<Colon> sz\<^sub>a\<^sub>d\<^sub>d\<^sub>r)::word))) \<noteq>(num\<^sub>3 \<Colon> sz\<^sub>a\<^sub>d\<^sub>d\<^sub>r)\<close>
      and \<open>succ (succ (succ (succ ((num\<^sub>1 \<Colon> sz\<^sub>a\<^sub>d\<^sub>d\<^sub>r)::word)))) \<noteq> (num\<^sub>3 \<Colon> sz\<^sub>a\<^sub>d\<^sub>d\<^sub>r)\<close>
      and \<open>succ (succ (succ (succ (succ ((num\<^sub>1 \<Colon> sz\<^sub>a\<^sub>d\<^sub>d\<^sub>r)::word))))) \<noteq> (num\<^sub>3 \<Colon> sz\<^sub>a\<^sub>d\<^sub>d\<^sub>r)\<close>
      and \<open>succ (succ (succ (succ (succ (succ ((num\<^sub>1 \<Colon> sz\<^sub>a\<^sub>d\<^sub>d\<^sub>r)::word)))))) \<noteq> (num\<^sub>3 \<Colon> sz\<^sub>a\<^sub>d\<^sub>d\<^sub>r)\<close>
      and \<open>succ (succ (succ (succ (succ (succ (succ ((num\<^sub>1 \<Colon> sz\<^sub>a\<^sub>d\<^sub>d\<^sub>r)::word))))))) \<noteq> (num\<^sub>3 \<Colon> sz\<^sub>a\<^sub>d\<^sub>d\<^sub>r)\<close>
  ...
  apply (rule refl_load_cut64I)
  apply (rule refl_load_cut64I)
  apply (rule refl32_load_rev_cut64I)
  apply assumption+
  by solve_succ_neq+
...
lemma word8_refl_load_rev_ext_concat_word64I: 
  assumes \<open>num < 2 ^ 64\<close>
    shows \<open>\<Delta> \<turnstile> v[num\<^sub>a \<Colon> 64 \<leftarrow> ext num \<Colon> 64 \<sim> hi : 7 \<sim> lo : 0, 8][succ (num\<^sub>a \<Colon> 64) \<leftarrow> ext num \<Colon> 64 \<sim> hi : 15 \<sim> lo : 8, 8][succ (succ (num\<^sub>a \<Colon> 64)) \<leftarrow> ext num \<Colon> 64 \<sim> hi : 23 \<sim> lo : 16, 8][succ (succ (succ (num\<^sub>a \<Colon> 64))) \<leftarrow> ext num \<Colon> 64 \<sim> hi : 31 \<sim> lo : 24, 8][succ (succ (succ (succ (num\<^sub>a \<Colon> 64)))) \<leftarrow> ext num \<Colon> 64 \<sim> hi : 39 \<sim> lo : 32, 8][succ (succ (succ (succ (succ (num\<^sub>a \<Colon> 64))))) \<leftarrow> ext num \<Colon> 64 \<sim> hi : 47 \<sim> lo : 40, 8][succ (succ (succ (succ (succ (succ (num\<^sub>a \<Colon> 64)))))) \<leftarrow> ext num \<Colon> 64 \<sim> hi : 55 \<sim> lo : 48, 8][succ (succ (succ (succ (succ (succ (succ (num\<^sub>a \<Colon> 64))))))) \<leftarrow> ext num \<Colon> 64 \<sim> hi : 63 \<sim> lo : 56, 8][num\<^sub>a \<Colon> 64, el]:u64 \<leadsto>* (num \<Colon> 64)\<close>
...
lemma word8_refl_load_rev_ext_concat_word32I:
  assumes \<open>val < 2 ^ 32\<close>
    shows 
  \<open>\<Delta> \<turnstile> extend:64[mem'[addr \<Colon> 64 \<leftarrow> ext val \<Colon> 32 \<sim> hi : 7 \<sim> lo : 0, 8]
                      [succ (addr \<Colon> 64) \<leftarrow> ext val \<Colon> 32 \<sim> hi : 15 \<sim> lo : 8, 8]
                      [succ (succ (addr \<Colon> 64)) \<leftarrow> ext val \<Colon> 32 \<sim> hi : 23 \<sim> lo : 16, 8]
                      [succ (succ (succ (addr \<Colon> 64))) \<leftarrow> ext val \<Colon> 32 \<sim> hi : 31 \<sim> lo : 24, 8]
                      [addr \<Colon> 64, el]:u32] \<leadsto>* (val \<Colon> 64)\<close>
  apply (subgoal_tac \<open>\<Delta> \<turnstile> extend:64[mem'[addr \<Colon> 64 \<leftarrow> ext val \<Colon> 32 \<sim> hi : 7 \<sim> lo : 0, 8]
                                         [succ (addr \<Colon> 64) \<leftarrow> ext val \<Colon> 32 \<sim> hi : 15 \<sim> lo : 8, 8]
                                         [succ (succ (addr \<Colon> 64)) \<leftarrow> ext val \<Colon> 32 \<sim> hi : 23 \<sim> lo : 16, 8]
                                         [succ (succ (succ (addr \<Colon> 64))) \<leftarrow> ext val \<Colon> 32 \<sim> hi : 31 \<sim> lo : 24, 8]
                                         [addr \<Colon> 64, el]:u32] \<leadsto>* exts ((((ext val \<Colon> 32 \<sim> hi : 31 \<sim> lo : 24) \<cdot> (ext val \<Colon> 32 \<sim> hi : 23 \<sim> lo : 16)) \<cdot> (ext val \<Colon> 32 \<sim> hi : 15 \<sim> lo : 8)) \<cdot> (ext val \<Colon> 32 \<sim> hi : 7 \<sim> lo : 0)) \<sim> hi : 63 \<sim> lo : 0\<close>)
  subgoal 
    apply (insert assms)
...
lemma word8_refl_store_el_word24I:
  ...
  subgoal
    unfolding succ.simps xtract.simps bv_plus.simps apply simp
    by solve_exp
  using word8_refl_store_el_word16_in_memI[of \<Delta> \<open>v\<close> num\<^sub>3 sz\<^sub>a\<^sub>d\<^sub>d\<^sub>r "take_bit 8 num\<^sub>4" "Suc num\<^sub>3 mod 2 ^ sz\<^sub>a\<^sub>d\<^sub>d\<^sub>r" "take_bit 16 (drop_bit 8 num\<^sub>4)"]
  unfolding xtract.simps succ.simps 
  apply simp
  sorry
...
lemma word8_refl_store_el_word32I:
  ...
  apply (insert assms)
  apply (rule REDUCE[of _ _ \<open>((Val v) with [num\<^sub>3 \<Colon> sz\<^sub>a\<^sub>d\<^sub>d\<^sub>r, el]:u8 \<leftarrow> low:8[num\<^sub>4 \<Colon> 32]) with [succ (num\<^sub>3 \<Colon> sz\<^sub>a\<^sub>d\<^sub>d\<^sub>r), el]:u32 - 8 \<leftarrow> high:32 - 8[num\<^sub>4 \<Colon> 32]\<close>])
  apply solve_exp
  apply simp
  ...
  apply solve_exp
  apply simp
  apply (rule REDUCE[of _ _ \<open>(v[num\<^sub>3 \<Colon> sz\<^sub>a\<^sub>d\<^sub>d\<^sub>r \<leftarrow> ext num\<^sub>4 \<Colon> 24 \<sim> hi : 7 \<sim> lo : 0, 8]) with [succ (num\<^sub>3 \<Colon> sz\<^sub>a\<^sub>d\<^sub>d\<^sub>r), el]:u24 \<leftarrow> ext num\<^sub>4 \<Colon> 32 \<sim> hi : 31 \<sim> lo : 8\<close>])
  unfolding succ.simps xtract.simps bv_plus.simps apply simp
  apply solve_exp
  unfolding drop_bit_mask_eq apply simp
  using word8_refl_store_el_word24_in_memI[of \<Delta> \<open>v\<close> num\<^sub>3 sz\<^sub>a\<^sub>d\<^sub>d\<^sub>r "and (mask 7) num\<^sub>4" "Suc num\<^sub>3 mod 2 ^ sz\<^sub>a\<^sub>d\<^sub>d\<^sub>r" "and (mask 23)
               (drop_bit 8 num\<^sub>4)"] unfolding xtract.simps
  unfolding drop_bit_mask_eq apply simp
  sorry
...
lemma word8_refl_store_el_word40I:
  ...
  apply solve_exp
  unfolding drop_bit_mask_eq apply simp
  using word8_refl_store_el_word32_in_memI[of \<Delta> \<open>v\<close> num\<^sub>3 sz\<^sub>a\<^sub>d\<^sub>d\<^sub>r "and (mask 7) num\<^sub>4" "Suc num\<^sub>3 mod 2 ^ sz\<^sub>a\<^sub>d\<^sub>d\<^sub>r" "and (mask 31)
               (drop_bit 8 num\<^sub>4)"] unfolding xtract.simps
  unfolding drop_bit_mask_eq apply simp
  sorry
...
lemma word8_refl_store_el_word48I:
  ...
  apply solve_exp
  unfolding drop_bit_mask_eq apply simp
  using word8_refl_store_el_word40_in_memI[of \<Delta> \<open>v\<close> num\<^sub>3 sz\<^sub>a\<^sub>d\<^sub>d\<^sub>r "and (mask 7) num\<^sub>4" "Suc num\<^sub>3 mod 2 ^ sz\<^sub>a\<^sub>d\<^sub>d\<^sub>r" "and (mask 39)
               (drop_bit 8 num\<^sub>4)"] unfolding xtract.simps
  unfolding drop_bit_mask_eq apply simp
  sorry
...
lemma word8_refl_store_el_word56I:
  ...
  apply solve_exp
  unfolding drop_bit_mask_eq apply simp
  using word8_refl_store_el_word48_in_memI[of \<Delta> v num\<^sub>3 sz\<^sub>a\<^sub>d\<^sub>d\<^sub>r "and (mask 7) num\<^sub>4" "Suc num\<^sub>3 mod 2 ^ sz\<^sub>a\<^sub>d\<^sub>d\<^sub>r" "and (mask 47)
               (drop_bit 8 num\<^sub>4)"] unfolding xtract.simps
  unfolding drop_bit_mask_eq apply simp
  sorry
...
lemma word8_refl_store_el_word64I:
  assumes \<open>type v = mem\<langle>sz\<^sub>a\<^sub>d\<^sub>d\<^sub>r, 8\<rangle>\<close>
    shows \<open>\<Delta> \<turnstile> Val v with [num\<^sub>3 \<Colon> sz\<^sub>a\<^sub>d\<^sub>d\<^sub>r, el]:u64 \<leftarrow> (num\<^sub>4 \<Colon> 64) \<leadsto>* 
      v[num\<^sub>3 \<Colon> sz\<^sub>a\<^sub>d\<^sub>d\<^sub>r \<leftarrow> ext num\<^sub>4 \<Colon> 64 \<sim> hi : 7 \<sim> lo : 0, 8]
       [succ (num\<^sub>3 \<Colon> sz\<^sub>a\<^sub>d\<^sub>d\<^sub>r) \<leftarrow> ext num\<^sub>4 \<Colon> 64 \<sim> hi : 15 \<sim> lo : 8, 8]
       [succ (succ (num\<^sub>3 \<Colon> sz\<^sub>a\<^sub>d\<^sub>d\<^sub>r)) \<leftarrow> ext num\<^sub>4 \<Colon> 64 \<sim> hi : 23 \<sim> lo : 16, 8]
       [succ (succ (succ (num\<^sub>3 \<Colon> sz\<^sub>a\<^sub>d\<^sub>d\<^sub>r))) \<leftarrow> ext num\<^sub>4 \<Colon> 64 \<sim> hi : 31 \<sim> lo : 24, 8]
       [succ (succ (succ (succ (num\<^sub>3 \<Colon> sz\<^sub>a\<^sub>d\<^sub>d\<^sub>r)))) \<leftarrow> ext num\<^sub>4 \<Colon> 64 \<sim> hi : 39 \<sim> lo : 32, 8]
       [succ (succ (succ (succ (succ (num\<^sub>3 \<Colon> sz\<^sub>a\<^sub>d\<^sub>d\<^sub>r))))) \<leftarrow> ext num\<^sub>4 \<Colon> 64 \<sim> hi : 47 \<sim> lo : 40, 8]
       [succ (succ (succ (succ (succ (succ (num\<^sub>3 \<Colon> sz\<^sub>a\<^sub>d\<^sub>d\<^sub>r)))))) \<leftarrow> ext num\<^sub>4 \<Colon> 64 \<sim> hi : 55 \<sim> lo : 48, 8]
       [succ (succ (succ (succ (succ (succ (succ (num\<^sub>3 \<Colon> sz\<^sub>a\<^sub>d\<^sub>d\<^sub>r))))))) \<leftarrow> ext num\<^sub>4 \<Colon> 64 \<sim> hi : 63 \<sim> lo : 56, 8]\<close>
  apply (insert assms)
  ...
  apply solve_exp
  unfolding drop_bit_mask_eq apply simp
  using word8_refl_store_el_word56_in_memI[of \<Delta> v num\<^sub>3 sz\<^sub>a\<^sub>d\<^sub>d\<^sub>r "and (mask 7) num\<^sub>4" "Suc num\<^sub>3 mod 2 ^ sz\<^sub>a\<^sub>d\<^sub>d\<^sub>r" "and (mask 55)
               (drop_bit 8 num\<^sub>4)"] unfolding xtract.simps
  unfolding drop_bit_mask_eq apply simp
  sorry
...
lemma word8_refl_store_el_word64_in_memI:
  \<open>\<Delta> \<turnstile> v[num\<^sub>1 \<Colon> sz\<^sub>a\<^sub>d\<^sub>d\<^sub>r \<leftarrow> num\<^sub>2 \<Colon> 8, 8] with [num\<^sub>3 \<Colon> sz\<^sub>a\<^sub>d\<^sub>d\<^sub>r, el]:u64 \<leftarrow> (num\<^sub>4 \<Colon> 64) \<leadsto>* 
      v[num\<^sub>1 \<Colon> sz\<^sub>a\<^sub>d\<^sub>d\<^sub>r \<leftarrow> num\<^sub>2 \<Colon> 8, 8]
       [num\<^sub>3 \<Colon> sz\<^sub>a\<^sub>d\<^sub>d\<^sub>r \<leftarrow> ext num\<^sub>4 \<Colon> 64 \<sim> hi : 7 \<sim> lo : 0, 8]
       [succ (num\<^sub>3 \<Colon> sz\<^sub>a\<^sub>d\<^sub>d\<^sub>r) \<leftarrow> ext num\<^sub>4 \<Colon> 64 \<sim> hi : 15 \<sim> lo : 8, 8]
       [succ (succ (num\<^sub>3 \<Colon> sz\<^sub>a\<^sub>d\<^sub>d\<^sub>r)) \<leftarrow> ext num\<^sub>4 \<Colon> 64 \<sim> hi : 23 \<sim> lo : 16, 8]
       [succ (succ (succ (num\<^sub>3 \<Colon> sz\<^sub>a\<^sub>d\<^sub>d\<^sub>r))) \<leftarrow> ext num\<^sub>4 \<Colon> 64 \<sim> hi : 31 \<sim> lo : 24, 8]
       [succ (succ (succ (succ (num\<^sub>3 \<Colon> sz\<^sub>a\<^sub>d\<^sub>d\<^sub>r)))) \<leftarrow> ext num\<^sub>4 \<Colon> 64 \<sim> hi : 39 \<sim> lo : 32, 8]
...
lemma REFL_WORD_AUX: 
  assumes \<open>v = (num \<Colon> sz)\<close>
    shows \<open>\<Delta> \<turnstile> (num \<Colon> sz) \<leadsto>* v\<close>
  using assms apply clarify
  by (rule REFL_WORD)

lemma refl_true_auxI:
  assumes \<open>v = true\<close>
    shows \<open>\<Delta> \<turnstile> true \<leadsto>* v\<close>
  using assms apply clarify
  by (rule REFL_TRUE)

lemma refl_false_auxI: 
  assumes \<open>v = false\<close>
    shows \<open>\<Delta> \<turnstile> false \<leadsto>* v\<close>
  using assms apply clarify
  by (rule REFL_FALSE)
...
method solve_exps = (
  ...
  match conclusion in
    ...
    \<open>_ \<turnstile> true \<leadsto>* true\<close> \<Rightarrow> \<open>rule REFL_TRUE\<close>
  \<bar> \<open>_ \<turnstile> true \<leadsto>* _\<close> \<Rightarrow> \<open>rule refl_true_auxI\<close>
  \<bar> \<open>_ \<turnstile> false \<leadsto>* false\<close> \<Rightarrow> \<open>rule REFL_FALSE\<close>
  \<bar> \<open>_ \<turnstile> false \<leadsto>* _\<close> \<Rightarrow> \<open>rule refl_false_auxI\<close>
  (* TODO clean up*)
  \<bar> \<open>_ \<turnstile> (_ \<Colon> _) \<leadsto>* (Immediate (_ \<Colon> _))\<close> \<Rightarrow> \<open>unfold Immediate_simp, rule REFL_WORD\<close>
  \<bar> \<open>_ \<turnstile> (_ \<Colon> _) \<leadsto>* (_ \<Colon> _)\<close> \<Rightarrow> \<open>rule REFL_WORD\<close>
  \<bar> \<open>_ \<turnstile> (_ \<Colon> _) \<leadsto>* _\<close> \<Rightarrow> \<open>rule REFL_WORD_AUX\<close>
  \<bar> \<open>_ \<turnstile> (_[_ \<leftarrow> _,_]) \<leadsto>* (_[_ \<leftarrow> _,_])\<close> \<Rightarrow> \<open>rule REFL_STORAGE\<close>
  \<bar> \<open>_ \<turnstile> (unknown[_]: _) \<leadsto>* (unknown[_]: _)\<close> \<Rightarrow> \<open>rule REFL_UNKNOWN\<close>
  \<bar> \<open>_ \<turnstile> (Val _) \<leadsto>* _\<close> \<Rightarrow> \<open>rule REFL\<close>
  \<bar> \<open>_ \<turnstile> (_ \<Colon> _) +\<^sub>b\<^sub>v (_ \<Colon> _) \<leadsto>* (_ \<Colon> _)\<close> \<Rightarrow> \<open>unfold bv_plus.simps, simp (no_asm) del: dvd_imp_mod_0 mod_less\<close>
  \<bar> \<open>_ \<turnstile> (_ \<Colon> _) =\<^sub>b\<^sub>v (_ \<Colon> _) \<leadsto>* _\<close> \<Rightarrow> \<open>unfold bv_eq_def, simp (no_asm) del: dvd_imp_mod_0 mod_less, solve_exps\<close>


    \<comment> \<open>Reducible Variables\<close>
  \<bar> \<open>_(var :\<^sub>t t \<mapsto> val) \<turnstile> var :\<^sub>t t \<leadsto>* val\<close> for var t val \<Rightarrow> \<open>rule refl_var_inI\<close>
  \<bar> \<open>_ \<turnstile> (_ :\<^sub>t _) \<leadsto>* (num \<Colon> sz)\<close> for num sz \<Rightarrow> \<open>rule REDUCE[of _ _ \<open>(num \<Colon> sz)\<close>], solve_exp, solve_exps\<close>
  \<bar> \<open>_ \<turnstile> (_ :\<^sub>t _) \<leadsto>* v\<close> for v \<Rightarrow> \<open>rule REDUCE[of _ _ \<open>Val v\<close>], solve_exp, solve_exps\<close>

    \<comment> \<open>Reducible Bops\<close>
  \<bar> \<open>_ \<turnstile> BinOp (num\<^sub>1 \<Colon> sz) (LOp Eq) (num\<^sub>2 \<Colon> sz) \<leadsto>* _\<close> for num\<^sub>1 num\<^sub>2 sz \<Rightarrow> \<open>rule REDUCE[of _ _ \<open>(num\<^sub>1 \<Colon> sz) =\<^sub>b\<^sub>v (num\<^sub>2 \<Colon> sz)\<close>], solve_exp, solve_exps\<close>
  \<bar> \<open>\<Delta> \<turnstile> BinOp (var :\<^sub>t t) bop e \<leadsto>* _\<close> for \<Delta> var t bop e \<Rightarrow> \<open>rule REDUCE[of _ _ \<open>BinOp (Val (the (\<Delta> (var :\<^sub>t t)))) bop e\<close>], (solve_exp, rule var_in_val_the_var, assumption?, (unfold in_vars_the_simp)?), solve_exps\<close>
  \<bar> \<open>\<Delta> \<turnstile> BinOp (num \<Colon> sz) bop (var :\<^sub>t t) \<leadsto>* _\<close> for \<Delta> num sz var t bop \<Rightarrow> \<open>rule REDUCE[of _ _ \<open>BinOp (num \<Colon> sz) bop (Val (the (\<Delta> (var :\<^sub>t t))))\<close>], (solve_exp, rule var_in_val_the_var, assumption?, (unfold in_vars_the_simp)?), solve_exps\<close>

    \<comment> \<open>Reducible Plus\<close>
  \<bar> \<open>\<Delta> \<turnstile> (var :\<^sub>t t) + (num \<Colon> sz) \<leadsto>* _\<close> for \<Delta> var t num sz \<Rightarrow> \<open>rule REDUCE[of _ _ \<open>Val (the (\<Delta> (var :\<^sub>t t))) + (num \<Colon> sz)\<close>], (solve_exp, rule var_in_val_the_var, assumption?, (unfold in_vars_the_simp)?), solve_exps\<close>
  \<bar> \<open>_ \<turnstile> (Val (_ \<Colon> _)) + (_ \<Colon> _) \<leadsto>* _\<close> \<Rightarrow> \<open>unfold Val_simp_word, solve_exps\<close>
  \<bar> \<open>_ \<turnstile> (num\<^sub>1 \<Colon> sz) + (num\<^sub>2 \<Colon> sz) \<leadsto>* _\<close> for num\<^sub>1 num\<^sub>2 sz \<Rightarrow> \<open>rule REDUCE[of _ _ \<open>(num\<^sub>1 \<Colon> sz) +\<^sub>b\<^sub>v (num\<^sub>2 \<Colon> sz)\<close>], solve_exp, solve_exps\<close>

    \<comment> \<open>Reducible Pad\<close>
  \<bar> \<open>_ \<turnstile> pad:sz'[num \<Colon> sz] \<leadsto>* (_ \<Colon> _)\<close> for sz' sz num \<Rightarrow> \<open>rule REDUCE[of _ _ \<open>ext num \<Colon> sz \<sim> hi : sz' - 1 \<sim> lo : 0\<close>], solve_exp, solve_exps\<close>

    \<comment> \<open>Reducible Store\<close>
  \<bar> \<open>_ \<turnstile> _[_ \<Colon> _ \<leftarrow> _ \<Colon> 8, 8] with [_ \<Colon> _, el]:u64 \<leftarrow> (_ \<Colon> 64) \<leadsto>* _[_ \<Colon> _ \<leftarrow> _ \<Colon> 8, 8][_ \<Colon> _ \<leftarrow> ext _ \<Colon> 64 \<sim> hi : 7 \<sim> lo : 0, 8][succ (_ \<Colon> _) \<leftarrow> ext _ \<Colon> 64 \<sim> hi : 15 \<sim> lo : 8, 8][succ (succ (_ \<Colon> _)) \<leftarrow> ext _ \<Colon> 64 \<sim> hi : 23 \<sim> lo : 16, 8][succ (succ (succ (_ \<Colon> _))) \<leftarrow> ext _ \<Colon> 64 \<sim> hi : 31 \<sim> lo : 24, 8][succ (succ (succ (succ (_ \<Colon> _)))) \<leftarrow> ext _ \<Colon> 64 \<sim> hi : 39 \<sim> lo : 32, 8][succ (succ (succ (succ (succ (_ \<Colon> _))))) \<leftarrow> ext _ \<Colon> 64 \<sim> hi : 47 \<sim> lo : 40, 8][succ (succ (succ (succ (succ (succ (_ \<Colon> _)))))) \<leftarrow> ext _ \<Colon> 64 \<sim> hi : 55 \<sim> lo : 48, 8][succ (succ (succ (succ (succ (succ (succ (_ \<Colon> _))))))) \<leftarrow> ext _ \<Colon> 64 \<sim> hi : 63 \<sim> lo : 56, 8]\<close> \<Rightarrow> \<open>(rule word8_refl_store_el_word64_in_memI)?\<close>
  \<bar> \<open>_ \<turnstile> Val _ with [_ \<Colon> _, el]:u64 \<leftarrow> (_ \<Colon> 64) \<leadsto>* _[_ \<Colon> _ \<leftarrow> ext _ \<Colon> 64 \<sim> hi : 7 \<sim> lo : 0, 8][succ (_ \<Colon> _) \<leftarrow> ext _ \<Colon> 64 \<sim> hi : 15 \<sim> lo : 8, 8][succ (succ (_ \<Colon> _)) \<leftarrow> ext _ \<Colon> 64 \<sim> hi : 23 \<sim> lo : 16, 8][succ (succ (succ (_ \<Colon> _))) \<leftarrow> ext _ \<Colon> 64 \<sim> hi : 31 \<sim> lo : 24, 8][succ (succ (succ (succ (_ \<Colon> _)))) \<leftarrow> ext _ \<Colon> 64 \<sim> hi : 39 \<sim> lo : 32, 8][succ (succ (succ (succ (succ (_ \<Colon> _))))) \<leftarrow> ext _ \<Colon> 64 \<sim> hi : 47 \<sim> lo : 40, 8][succ (succ (succ (succ (succ (succ (_ \<Colon> _)))))) \<leftarrow> ext _ \<Colon> 64 \<sim> hi : 55 \<sim> lo : 48, 8][succ (succ (succ (succ (succ (succ (succ (_ \<Colon> _))))))) \<leftarrow> ext _ \<Colon> 64 \<sim> hi : 63 \<sim> lo : 56, 8]\<close> \<Rightarrow> \<open>(rule word8_refl_store_el_word64I, blast)?\<close>
  \<bar> \<open>_ \<turnstile> _[_ \<Colon> _ \<leftarrow> _ \<Colon> 8, 8] with [_ \<Colon> _, el]:u32 \<leftarrow> (_ \<Colon> 32) \<leadsto>* _[_ \<Colon> _ \<leftarrow> _ \<Colon> 8, 8][_ \<Colon> _ \<leftarrow> ext _ \<Colon> 32 \<sim> hi : 7 \<sim> lo : 0, 8][succ (_ \<Colon> _) \<leftarrow> ext _ \<Colon> 32 \<sim> hi : 15 \<sim> lo : 8, 8][succ (succ (_ \<Colon> _)) \<leftarrow> ext _ \<Colon> 32 \<sim> hi : 23 \<sim> lo : 16, 8][succ (succ (succ (_ \<Colon> _))) \<leftarrow> ext _ \<Colon> 32 \<sim> hi : 31 \<sim> lo : 24, 8]\<close> \<Rightarrow> \<open>(rule word8_refl_store_el_word32_in_memI)?\<close>
  \<bar> \<open>_ \<turnstile> Val _ with [_ \<Colon> _, el]:u32 \<leftarrow> (_ \<Colon> 32) \<leadsto>* _[_ \<Colon> _ \<leftarrow> ext _ \<Colon> 32 \<sim> hi : 7 \<sim> lo : 0, 8][succ (_ \<Colon> _) \<leftarrow> ext _ \<Colon> 32 \<sim> hi : 15 \<sim> lo : 8, 8][succ (succ (_ \<Colon> _)) \<leftarrow> ext _ \<Colon> 32 \<sim> hi : 23 \<sim> lo : 16, 8][succ (succ (succ (_ \<Colon> _))) \<leftarrow> ext _ \<Colon> 32 \<sim> hi : 31 \<sim> lo : 24, 8]\<close> \<Rightarrow> \<open>(rule word8_refl_store_el_word32I, blast)?\<close>

  \<bar> \<open>\<Delta> \<turnstile> extend:sz\<^sub>1[mem[(var :\<^sub>t t) + (num \<Colon> sz\<^sub>2), en]:usz\<^sub>3] \<leadsto>* _\<close> for \<Delta> mem var t num sz\<^sub>1 sz\<^sub>2 sz\<^sub>3 en \<Rightarrow> \<open>rule REDUCE[of _ _ \<open>extend:sz\<^sub>1[mem[Val (the (\<Delta> (var :\<^sub>t t))) + (num \<Colon> sz\<^sub>2), en]:usz\<^sub>3]\<close>], solve_exp, rule var_in_val_the_var, assumption?, (unfold in_vars_the_simp)?, solve_exps\<close>
  \<bar> \<open>_ \<turnstile> extend:sz\<^sub>1[mem[(num\<^sub>1 \<Colon> sz\<^sub>2) + (num\<^sub>2 \<Colon> sz\<^sub>2), en]:usz\<^sub>3] \<leadsto>* _\<close> for mem num\<^sub>1 num\<^sub>2 sz\<^sub>1 sz\<^sub>2 sz\<^sub>3 en \<Rightarrow> \<open>rule REDUCE[of _ _ \<open>extend:sz\<^sub>1[mem[(num\<^sub>1 \<Colon> sz\<^sub>2) +\<^sub>b\<^sub>v (num\<^sub>2 \<Colon> sz\<^sub>2), en]:usz\<^sub>3]\<close>], solve_exp, unfold bv_plus.simps, solve_exps\<close>
  ...
  \<bar> \<open>_ \<turnstile> extend:sz\<^sub>1[low:sz\<^sub>2[(num\<^sub>1 \<Colon> sz\<^sub>a\<^sub>d\<^sub>d\<^sub>r) + (num\<^sub>2 \<Colon> sz\<^sub>a\<^sub>d\<^sub>d\<^sub>r)]] \<leadsto>* _\<close> for num\<^sub>1 num\<^sub>2 sz\<^sub>1 sz\<^sub>2 sz\<^sub>a\<^sub>d\<^sub>d\<^sub>r \<Rightarrow>  \<open>rule REDUCE[of _ _ \<open>extend:sz\<^sub>1[low:sz\<^sub>2[(num\<^sub>1 \<Colon> sz\<^sub>a\<^sub>d\<^sub>d\<^sub>r) +\<^sub>b\<^sub>v (num\<^sub>2 \<Colon> sz\<^sub>a\<^sub>d\<^sub>d\<^sub>r)]]\<close>], solve_exp, unfold bv_plus.simps, solve_exps\<close>

  \<bar> \<open>\<Delta> \<turnstile> extend:sz\<^sub>1[low:sz\<^sub>2[(var :\<^sub>t t)]] \<leadsto>* _\<close> for \<Delta> var t sz\<^sub>1 sz\<^sub>2 \<Rightarrow>  \<open>rule REDUCE[of _ _ \<open>extend:sz\<^sub>1[low:sz\<^sub>2[Val (the (\<Delta> (var :\<^sub>t t)))]]\<close>], solve_exp, rule var_in_val_the_var, assumption?, (unfold in_vars_the_simp)?, solve_exps\<close>
  \<bar> \<open>_ \<turnstile> extend:sz\<^sub>1[low:sz\<^sub>2[num \<Colon> sz\<^sub>a\<^sub>d\<^sub>d\<^sub>r]] \<leadsto>* _\<close> for sz\<^sub>1 sz\<^sub>2 num sz\<^sub>a\<^sub>d\<^sub>d\<^sub>r \<Rightarrow>  \<open>rule REDUCE[of _ _ \<open>extend:sz\<^sub>1[ext num \<Colon> sz\<^sub>a\<^sub>d\<^sub>d\<^sub>r \<sim> hi : sz\<^sub>2 - 1 \<sim> lo : 0]\<close>], solve_exp, solve_exps\<close>
  \<bar> \<open>_ \<turnstile> extend:sz\<^sub>1[num \<Colon> sz\<^sub>a\<^sub>d\<^sub>d\<^sub>r] \<leadsto>* _\<close> for sz\<^sub>1 num sz\<^sub>a\<^sub>d\<^sub>d\<^sub>r \<Rightarrow>  \<open>rule REDUCE[of _ _ \<open>exts num \<Colon> sz\<^sub>a\<^sub>d\<^sub>d\<^sub>r \<sim> hi : sz\<^sub>1 - 1 \<sim> lo : 0\<close>], solve_exp, solve_exps\<close>


   \<comment> \<open>LOAD_STEP_ADDR\<close>
  \<bar> \<open>\<Delta> \<turnstile> e\<^sub>1[(var :\<^sub>t t), en]:usz \<leadsto>* _\<close> for \<Delta> e\<^sub>1 var t en sz \<Rightarrow> \<open>rule REDUCE[of _ _ \<open>e\<^sub>1[(Val (the (\<Delta> (var :\<^sub>t t)))), en]:usz\<close>], solve_exp, rule var_in_val_the_var, assumption?, (unfold in_vars_the_simp)?, solve_exps\<close>
  \<bar> \<open>\<Delta> \<turnstile> e\<^sub>1[(var :\<^sub>t t) + e\<^sub>2, en]:usz \<leadsto>* _\<close> for \<Delta> e\<^sub>1 var t e\<^sub>2 en sz \<Rightarrow> \<open>rule REDUCE[of _ _ \<open>e\<^sub>1[(Val (the (\<Delta> (var :\<^sub>t t)))) + e\<^sub>2, en]:usz\<close>], solve_exp, rule var_in_val_the_var, assumption?, (unfold in_vars_the_simp)?, solve_exps\<close>
  \<bar> \<open>_ \<turnstile> e\<^sub>1[(num\<^sub>1 \<Colon> sz\<^sub>a\<^sub>d\<^sub>d\<^sub>r) + (num\<^sub>2 \<Colon> sz\<^sub>a\<^sub>d\<^sub>d\<^sub>r), en]:usz \<leadsto>* _\<close> for e\<^sub>1 num\<^sub>1 num\<^sub>2 en sz\<^sub>a\<^sub>d\<^sub>d\<^sub>r sz \<Rightarrow> \<open>rule REDUCE[of _ _ \<open>e\<^sub>1[(num\<^sub>1 \<Colon> sz\<^sub>a\<^sub>d\<^sub>d\<^sub>r) +\<^sub>b\<^sub>v (num\<^sub>2 \<Colon> sz\<^sub>a\<^sub>d\<^sub>d\<^sub>r), en]:usz\<close>], solve_exp, unfold bv_plus.simps, solve_exps\<close>

  (*\<bar> \<open>extend:sz\<^sub>1[mem[X8 + (num\<^sub>2 \<Colon> sz\<^sub>a\<^sub>d\<^sub>d\<^sub>r), en]:usz\<^sub>2] \<leadsto>* _*)
  ...
  \<bar> \<open>_ \<turnstile> ((((((_[num\<^sub>a\<^sub>d\<^sub>d\<^sub>r \<Colon> sz\<^sub>a\<^sub>d\<^sub>d\<^sub>r \<leftarrow> num\<^sub>8 \<Colon> sz, sz][num\<^sub>a\<^sub>d\<^sub>d\<^sub>r \<Colon> sz\<^sub>a\<^sub>d\<^sub>d\<^sub>r, _]:usz @ (num\<^sub>7 \<Colon> sz)) @ (num\<^sub>6 \<Colon> sz)) @ (num\<^sub>5 \<Colon> sz)) @ (num\<^sub>4 \<Colon> sz)) @ (num\<^sub>3 \<Colon> sz)) @ (num\<^sub>2 \<Colon> sz)) @ (num\<^sub>1 \<Colon> sz) \<leadsto>* _\<close> for num\<^sub>1 num\<^sub>2 num\<^sub>3 num\<^sub>4 num\<^sub>5 num\<^sub>6 num\<^sub>7 num\<^sub>8 num\<^sub>a\<^sub>d\<^sub>d\<^sub>r sz\<^sub>a\<^sub>d\<^sub>d\<^sub>r sz \<Rightarrow> \<open>rule REDUCE[of _ _ \<open>(((((((num\<^sub>8 \<Colon> sz) @ (num\<^sub>7 \<Colon> sz)) @ (num\<^sub>6 \<Colon> sz)) @ (num\<^sub>5 \<Colon> sz)) @ (num\<^sub>4 \<Colon> sz)) @ (num\<^sub>3 \<Colon> sz)) @ (num\<^sub>2 \<Colon> sz)) @ (num\<^sub>1 \<Colon> sz)\<close>], solve_exp, solve_exps\<close>
  \<bar> \<open>_ \<turnstile> ((((((v[num\<^sub>a\<^sub>d\<^sub>d\<^sub>r' \<Colon> sz\<^sub>a\<^sub>d\<^sub>d\<^sub>r \<leftarrow> num\<^sub>8 \<Colon> sz, sz][_ \<Colon> _ \<leftarrow> _ \<Colon> _, _][num\<^sub>a\<^sub>d\<^sub>d\<^sub>r \<Colon> sz\<^sub>a\<^sub>d\<^sub>d\<^sub>r, en]:usz @ (num\<^sub>7 \<Colon> sz)) @ (num\<^sub>6 \<Colon> sz)) @ (num\<^sub>5 \<Colon> sz)) @ (num\<^sub>4 \<Colon> sz)) @ (num\<^sub>3 \<Colon> sz)) @ (num\<^sub>2 \<Colon> sz)) @ (num\<^sub>1 \<Colon> sz) \<leadsto>* _\<close> for v num\<^sub>1 num\<^sub>2 num\<^sub>3 num\<^sub>4 num\<^sub>5 num\<^sub>6 num\<^sub>7 num\<^sub>8 num\<^sub>a\<^sub>d\<^sub>d\<^sub>r num\<^sub>a\<^sub>d\<^sub>d\<^sub>r' sz\<^sub>a\<^sub>d\<^sub>d\<^sub>r sz en \<Rightarrow> \<open>rule REDUCE[of _ _ \<open>(((((((v[num\<^sub>a\<^sub>d\<^sub>d\<^sub>r' \<Colon> sz\<^sub>a\<^sub>d\<^sub>d\<^sub>r \<leftarrow> num\<^sub>8 \<Colon> sz, sz][num\<^sub>a\<^sub>d\<^sub>d\<^sub>r \<Colon> sz\<^sub>a\<^sub>d\<^sub>d\<^sub>r, en]:usz) @ (num\<^sub>7 \<Colon> sz)) @ (num\<^sub>6 \<Colon> sz)) @ (num\<^sub>5 \<Colon> sz)) @ (num\<^sub>4 \<Colon> sz)) @ (num\<^sub>3 \<Colon> sz)) @ (num\<^sub>2 \<Colon> sz)) @ (num\<^sub>1 \<Colon> sz)\<close>], solve_exp, solve_exps\<close>
  \<bar> \<open>_ \<turnstile> ((((((e @ (_[num\<^sub>a\<^sub>d\<^sub>d\<^sub>r \<Colon> sz\<^sub>a\<^sub>d\<^sub>d\<^sub>r \<leftarrow> num\<^sub>7 \<Colon> sz, sz][num\<^sub>a\<^sub>d\<^sub>d\<^sub>r \<Colon> sz\<^sub>a\<^sub>d\<^sub>d\<^sub>r, _]:usz)) @ (num\<^sub>6 \<Colon> sz)) @ (num\<^sub>5 \<Colon> sz)) @ (num\<^sub>4 \<Colon> sz)) @ (num\<^sub>3 \<Colon> sz)) @ (num\<^sub>2 \<Colon> sz)) @ (num\<^sub>1 \<Colon> sz) \<leadsto>* _\<close> for num\<^sub>1 num\<^sub>2 num\<^sub>3 num\<^sub>4 num\<^sub>5 num\<^sub>6 num\<^sub>7 num\<^sub>a\<^sub>d\<^sub>d\<^sub>r sz\<^sub>a\<^sub>d\<^sub>d\<^sub>r sz e \<Rightarrow> \<open>rule REDUCE[of _ _ \<open>((((((e @ (num\<^sub>7 \<Colon> sz)) @ (num\<^sub>6 \<Colon> sz)) @ (num\<^sub>5 \<Colon> sz)) @ (num\<^sub>4 \<Colon> sz)) @ (num\<^sub>3 \<Colon> sz)) @ (num\<^sub>2 \<Colon> sz)) @ (num\<^sub>1 \<Colon> sz)\<close>], solve_exp\<close>
  \<bar> \<open>_ \<turnstile> ((((((e @ (v[num\<^sub>a\<^sub>d\<^sub>d\<^sub>r' \<Colon> sz\<^sub>a\<^sub>d\<^sub>d\<^sub>r \<leftarrow> num\<^sub>7 \<Colon> sz, sz][_ \<Colon> _ \<leftarrow> _ \<Colon> _, _][num\<^sub>a\<^sub>d\<^sub>d\<^sub>r \<Colon> sz\<^sub>a\<^sub>d\<^sub>d\<^sub>r, en]:usz)) @ (num\<^sub>6 \<Colon> sz)) @ (num\<^sub>5 \<Colon> sz)) @ (num\<^sub>4 \<Colon> sz)) @ (num\<^sub>3 \<Colon> sz)) @ (num\<^sub>2 \<Colon> sz)) @ (num\<^sub>1 \<Colon> sz) \<leadsto>* _\<close> for num\<^sub>1 num\<^sub>2 num\<^sub>3 num\<^sub>4 num\<^sub>5 num\<^sub>6 num\<^sub>7 num\<^sub>a\<^sub>d\<^sub>d\<^sub>r num\<^sub>a\<^sub>d\<^sub>d\<^sub>r' sz\<^sub>a\<^sub>d\<^sub>d\<^sub>r sz e v en \<Rightarrow> \<open>rule REDUCE[of _ _ \<open>((((((e @ (v[num\<^sub>a\<^sub>d\<^sub>d\<^sub>r' \<Colon> sz\<^sub>a\<^sub>d\<^sub>d\<^sub>r \<leftarrow> num\<^sub>7 \<Colon> sz, sz][num\<^sub>a\<^sub>d\<^sub>d\<^sub>r \<Colon> sz\<^sub>a\<^sub>d\<^sub>d\<^sub>r, en]:usz)) @ (num\<^sub>6 \<Colon> sz)) @ (num\<^sub>5 \<Colon> sz)) @ (num\<^sub>4 \<Colon> sz)) @ (num\<^sub>3 \<Colon> sz)) @ (num\<^sub>2 \<Colon> sz)) @ (num\<^sub>1 \<Colon> sz)\<close>], solve_exp, solve_exps\<close>
  \<bar> \<open>_ \<turnstile> (((((e @ (_[num\<^sub>a\<^sub>d\<^sub>d\<^sub>r \<Colon> sz\<^sub>a\<^sub>d\<^sub>d\<^sub>r \<leftarrow> num\<^sub>6 \<Colon> sz, sz][num\<^sub>a\<^sub>d\<^sub>d\<^sub>r \<Colon> sz\<^sub>a\<^sub>d\<^sub>d\<^sub>r, _]:usz)) @ (num\<^sub>5 \<Colon> sz)) @ (num\<^sub>4 \<Colon> sz)) @ (num\<^sub>3 \<Colon> sz)) @ (num\<^sub>2 \<Colon> sz)) @ (num\<^sub>1 \<Colon> sz) \<leadsto>* _\<close> for num\<^sub>1 num\<^sub>2 num\<^sub>3 num\<^sub>4 num\<^sub>5 num\<^sub>6 num\<^sub>a\<^sub>d\<^sub>d\<^sub>r sz\<^sub>a\<^sub>d\<^sub>d\<^sub>r sz e \<Rightarrow> \<open>rule REDUCE[of _ _ \<open>(((((e @ (num\<^sub>6 \<Colon> sz)) @ (num\<^sub>5 \<Colon> sz)) @ (num\<^sub>4 \<Colon> sz)) @ (num\<^sub>3 \<Colon> sz)) @ (num\<^sub>2 \<Colon> sz)) @ (num\<^sub>1 \<Colon> sz)\<close>], solve_exp\<close>
  \<bar> \<open>_ \<turnstile> (((((e @ (v[num\<^sub>a\<^sub>d\<^sub>d\<^sub>r' \<Colon> sz\<^sub>a\<^sub>d\<^sub>d\<^sub>r \<leftarrow> num\<^sub>6 \<Colon> sz, sz][_ \<Colon> _ \<leftarrow> _ \<Colon> _, _][num\<^sub>a\<^sub>d\<^sub>d\<^sub>r \<Colon> sz\<^sub>a\<^sub>d\<^sub>d\<^sub>r, en]:usz)) @ (num\<^sub>5 \<Colon> sz)) @ (num\<^sub>4 \<Colon> sz)) @ (num\<^sub>3 \<Colon> sz)) @ (num\<^sub>2 \<Colon> sz)) @ (num\<^sub>1 \<Colon> sz) \<leadsto>* _\<close> for num\<^sub>1 num\<^sub>2 num\<^sub>3 num\<^sub>4 num\<^sub>5 num\<^sub>6 num\<^sub>a\<^sub>d\<^sub>d\<^sub>r num\<^sub>a\<^sub>d\<^sub>d\<^sub>r' sz\<^sub>a\<^sub>d\<^sub>d\<^sub>r sz e v en \<Rightarrow> \<open>rule REDUCE[of _ _ \<open>(((((e @ (v[num\<^sub>a\<^sub>d\<^sub>d\<^sub>r' \<Colon> sz\<^sub>a\<^sub>d\<^sub>d\<^sub>r \<leftarrow> num\<^sub>6 \<Colon> sz, sz][num\<^sub>a\<^sub>d\<^sub>d\<^sub>r \<Colon> sz\<^sub>a\<^sub>d\<^sub>d\<^sub>r, en]:usz)) @ (num\<^sub>5 \<Colon> sz)) @ (num\<^sub>4 \<Colon> sz)) @ (num\<^sub>3 \<Colon> sz)) @ (num\<^sub>2 \<Colon> sz)) @ (num\<^sub>1 \<Colon> sz)\<close>], solve_exp, solve_exps\<close>
  \<bar> \<open>_ \<turnstile> ((((e @ (_[num\<^sub>a\<^sub>d\<^sub>d\<^sub>r \<Colon> sz\<^sub>a\<^sub>d\<^sub>d\<^sub>r \<leftarrow> num\<^sub>5 \<Colon> sz, sz][num\<^sub>a\<^sub>d\<^sub>d\<^sub>r \<Colon> sz\<^sub>a\<^sub>d\<^sub>d\<^sub>r, _]:usz)) @ (num\<^sub>4 \<Colon> sz)) @ (num\<^sub>3 \<Colon> sz)) @ (num\<^sub>2 \<Colon> sz)) @ (num\<^sub>1 \<Colon> sz) \<leadsto>* _\<close> for num\<^sub>1 num\<^sub>2 num\<^sub>3 num\<^sub>4 num\<^sub>5 num\<^sub>a\<^sub>d\<^sub>d\<^sub>r sz\<^sub>a\<^sub>d\<^sub>d\<^sub>r sz e \<Rightarrow> \<open>rule REDUCE[of _ _ \<open>((((e @ (num\<^sub>5 \<Colon> sz)) @ (num\<^sub>4 \<Colon> sz)) @ (num\<^sub>3 \<Colon> sz)) @ (num\<^sub>2 \<Colon> sz)) @ (num\<^sub>1 \<Colon> sz)\<close>], solve_exp\<close>
  \<bar> \<open>_ \<turnstile> ((((e @ (v[num\<^sub>a\<^sub>d\<^sub>d\<^sub>r' \<Colon> sz\<^sub>a\<^sub>d\<^sub>d\<^sub>r \<leftarrow> num\<^sub>5 \<Colon> sz, sz][_ \<Colon> _ \<leftarrow> _ \<Colon> _, _][num\<^sub>a\<^sub>d\<^sub>d\<^sub>r \<Colon> sz\<^sub>a\<^sub>d\<^sub>d\<^sub>r, en]:usz)) @ (num\<^sub>4 \<Colon> sz)) @ (num\<^sub>3 \<Colon> sz)) @ (num\<^sub>2 \<Colon> sz)) @ (num\<^sub>1 \<Colon> sz) \<leadsto>* _\<close> for num\<^sub>1 num\<^sub>2 num\<^sub>3 num\<^sub>4 num\<^sub>5 num\<^sub>a\<^sub>d\<^sub>d\<^sub>r num\<^sub>a\<^sub>d\<^sub>d\<^sub>r' sz\<^sub>a\<^sub>d\<^sub>d\<^sub>r sz e v en \<Rightarrow> \<open>rule REDUCE[of _ _ \<open>((((e @ (v[num\<^sub>a\<^sub>d\<^sub>d\<^sub>r' \<Colon> sz\<^sub>a\<^sub>d\<^sub>d\<^sub>r \<leftarrow> num\<^sub>5 \<Colon> sz, sz][num\<^sub>a\<^sub>d\<^sub>d\<^sub>r \<Colon> sz\<^sub>a\<^sub>d\<^sub>d\<^sub>r, en]:usz)) @ (num\<^sub>4 \<Colon> sz)) @ (num\<^sub>3 \<Colon> sz)) @ (num\<^sub>2 \<Colon> sz)) @ (num\<^sub>1 \<Colon> sz)\<close>], solve_exp, solve_exps\<close>
  \<bar> \<open>_ \<turnstile> (((e @ (_[num\<^sub>a\<^sub>d\<^sub>d\<^sub>r \<Colon> sz\<^sub>a\<^sub>d\<^sub>d\<^sub>r \<leftarrow> num\<^sub>4 \<Colon> sz, sz][num\<^sub>a\<^sub>d\<^sub>d\<^sub>r \<Colon> sz\<^sub>a\<^sub>d\<^sub>d\<^sub>r, _]:usz)) @ (num\<^sub>3 \<Colon> sz)) @ (num\<^sub>2 \<Colon> sz)) @ (num\<^sub>1 \<Colon> sz) \<leadsto>* _\<close> for num\<^sub>1 num\<^sub>2 num\<^sub>3 num\<^sub>4 num\<^sub>a\<^sub>d\<^sub>d\<^sub>r sz\<^sub>a\<^sub>d\<^sub>d\<^sub>r sz e \<Rightarrow> \<open>rule REDUCE[of _ _ \<open>(((e @ (num\<^sub>4 \<Colon> sz)) @ (num\<^sub>3 \<Colon> sz)) @ (num\<^sub>2 \<Colon> sz)) @ (num\<^sub>1 \<Colon> sz)\<close>], solve_exp\<close>
  \<bar> \<open>_ \<turnstile> (((e @ (v[num\<^sub>a\<^sub>d\<^sub>d\<^sub>r' \<Colon> sz\<^sub>a\<^sub>d\<^sub>d\<^sub>r \<leftarrow> num\<^sub>4 \<Colon> sz, sz][_ \<Colon> _ \<leftarrow> _ \<Colon> _, _][num\<^sub>a\<^sub>d\<^sub>d\<^sub>r \<Colon> sz\<^sub>a\<^sub>d\<^sub>d\<^sub>r, en]:usz)) @ (num\<^sub>3 \<Colon> sz)) @ (num\<^sub>2 \<Colon> sz)) @ (num\<^sub>1 \<Colon> sz) \<leadsto>* _\<close> for num\<^sub>1 num\<^sub>2 num\<^sub>3 num\<^sub>4 num\<^sub>a\<^sub>d\<^sub>d\<^sub>r num\<^sub>a\<^sub>d\<^sub>d\<^sub>r' sz\<^sub>a\<^sub>d\<^sub>d\<^sub>r sz e v en \<Rightarrow> \<open>rule REDUCE[of _ _ \<open>(((e @ (v[num\<^sub>a\<^sub>d\<^sub>d\<^sub>r' \<Colon> sz\<^sub>a\<^sub>d\<^sub>d\<^sub>r \<leftarrow> num\<^sub>4 \<Colon> sz, sz][num\<^sub>a\<^sub>d\<^sub>d\<^sub>r \<Colon> sz\<^sub>a\<^sub>d\<^sub>d\<^sub>r, en]:usz)) @ (num\<^sub>3 \<Colon> sz)) @ (num\<^sub>2 \<Colon> sz)) @ (num\<^sub>1 \<Colon> sz)\<close>], solve_exp, solve_exps\<close>
  \<bar> \<open>_ \<turnstile> ((e @ (_[num\<^sub>a\<^sub>d\<^sub>d\<^sub>r \<Colon> sz\<^sub>a\<^sub>d\<^sub>d\<^sub>r \<leftarrow> num\<^sub>3 \<Colon> sz, sz][num\<^sub>a\<^sub>d\<^sub>d\<^sub>r \<Colon> sz\<^sub>a\<^sub>d\<^sub>d\<^sub>r, _]:usz)) @ (num\<^sub>2 \<Colon> sz)) @ (num\<^sub>1 \<Colon> sz) \<leadsto>* _\<close> for num\<^sub>1 num\<^sub>2 num\<^sub>3 num\<^sub>a\<^sub>d\<^sub>d\<^sub>r sz\<^sub>a\<^sub>d\<^sub>d\<^sub>r sz e \<Rightarrow> \<open>rule REDUCE[of _ _ \<open>((e @ (num\<^sub>3 \<Colon> sz)) @ (num\<^sub>2 \<Colon> sz)) @ (num\<^sub>1 \<Colon> sz)\<close>], solve_exp\<close>
  \<bar> \<open>_ \<turnstile> ((e @ (v[num\<^sub>a\<^sub>d\<^sub>d\<^sub>r' \<Colon> sz\<^sub>a\<^sub>d\<^sub>d\<^sub>r \<leftarrow> num\<^sub>3 \<Colon> sz, sz][_ \<Colon> _ \<leftarrow> _ \<Colon> _, _][num\<^sub>a\<^sub>d\<^sub>d\<^sub>r \<Colon> sz\<^sub>a\<^sub>d\<^sub>d\<^sub>r, en]:usz)) @ (num\<^sub>2 \<Colon> sz)) @ (num\<^sub>1 \<Colon> sz) \<leadsto>* _\<close> for num\<^sub>1 num\<^sub>2 num\<^sub>3 num\<^sub>a\<^sub>d\<^sub>d\<^sub>r num\<^sub>a\<^sub>d\<^sub>d\<^sub>r' sz\<^sub>a\<^sub>d\<^sub>d\<^sub>r sz e v en \<Rightarrow> \<open>rule REDUCE[of _ _ \<open>((e @ (v[num\<^sub>a\<^sub>d\<^sub>d\<^sub>r' \<Colon> sz\<^sub>a\<^sub>d\<^sub>d\<^sub>r \<leftarrow> num\<^sub>3 \<Colon> sz, sz][num\<^sub>a\<^sub>d\<^sub>d\<^sub>r \<Colon> sz\<^sub>a\<^sub>d\<^sub>d\<^sub>r, en]:usz)) @ (num\<^sub>2 \<Colon> sz)) @ (num\<^sub>1 \<Colon> sz)\<close>], solve_exp, solve_exps\<close>
  \<bar> \<open>_ \<turnstile> (e @ (_[num\<^sub>a\<^sub>d\<^sub>d\<^sub>r \<Colon> sz\<^sub>a\<^sub>d\<^sub>d\<^sub>r \<leftarrow> num\<^sub>2 \<Colon> sz, sz][num\<^sub>a\<^sub>d\<^sub>d\<^sub>r \<Colon> sz\<^sub>a\<^sub>d\<^sub>d\<^sub>r, _]:usz)) @ (num\<^sub>1 \<Colon> sz) \<leadsto>* _\<close> for num\<^sub>1 num\<^sub>2 num\<^sub>a\<^sub>d\<^sub>d\<^sub>r sz\<^sub>a\<^sub>d\<^sub>d\<^sub>r sz e \<Rightarrow> \<open>rule REDUCE[of _ _ \<open>(e @ (num\<^sub>2 \<Colon> sz)) @ (num\<^sub>1 \<Colon> sz)\<close>], solve_exp\<close>
  \<bar> \<open>_ \<turnstile> (e @ (v[num\<^sub>a\<^sub>d\<^sub>d\<^sub>r' \<Colon> sz\<^sub>a\<^sub>d\<^sub>d\<^sub>r \<leftarrow> num\<^sub>2 \<Colon> sz, sz][_ \<Colon> _ \<leftarrow> _ \<Colon> _, _][num\<^sub>a\<^sub>d\<^sub>d\<^sub>r \<Colon> sz\<^sub>a\<^sub>d\<^sub>d\<^sub>r, en]:usz)) @ (num\<^sub>1 \<Colon> sz) \<leadsto>* _\<close> for num\<^sub>1 num\<^sub>2 num\<^sub>a\<^sub>d\<^sub>d\<^sub>r num\<^sub>a\<^sub>d\<^sub>d\<^sub>r' sz\<^sub>a\<^sub>d\<^sub>d\<^sub>r sz e v en \<Rightarrow> \<open>rule REDUCE[of _ _ \<open>(e @ (v[num\<^sub>a\<^sub>d\<^sub>d\<^sub>r' \<Colon> sz\<^sub>a\<^sub>d\<^sub>d\<^sub>r \<leftarrow> num\<^sub>2 \<Colon> sz, sz][num\<^sub>a\<^sub>d\<^sub>d\<^sub>r \<Colon> sz\<^sub>a\<^sub>d\<^sub>d\<^sub>r, en]:usz)) @ (num\<^sub>1 \<Colon> sz)\<close>], solve_exp, solve_exps\<close>
  \<bar> \<open>_ \<turnstile> e @ (_[num\<^sub>a\<^sub>d\<^sub>d\<^sub>r \<Colon> sz\<^sub>a\<^sub>d\<^sub>d\<^sub>r \<leftarrow> num\<^sub>1 \<Colon> sz, sz][num\<^sub>a\<^sub>d\<^sub>d\<^sub>r \<Colon> sz\<^sub>a\<^sub>d\<^sub>d\<^sub>r, _]:usz) \<leadsto>* _\<close> for num\<^sub>1 num\<^sub>a\<^sub>d\<^sub>d\<^sub>r sz\<^sub>a\<^sub>d\<^sub>d\<^sub>r sz e \<Rightarrow> \<open>rule REDUCE[of _ _ \<open>e @ (num\<^sub>1 \<Colon> sz)\<close>], solve_exp\<close>
  \<bar> \<open>_ \<turnstile> e @ (v[num\<^sub>a\<^sub>d\<^sub>d\<^sub>r' \<Colon> sz\<^sub>a\<^sub>d\<^sub>d\<^sub>r \<leftarrow> num\<^sub>1 \<Colon> sz, sz][_ \<Colon> _ \<leftarrow> _ \<Colon> _, _][num\<^sub>a\<^sub>d\<^sub>d\<^sub>r \<Colon> sz\<^sub>a\<^sub>d\<^sub>d\<^sub>r, en]:usz) \<leadsto>* _\<close> for num\<^sub>1 num\<^sub>a\<^sub>d\<^sub>d\<^sub>r num\<^sub>a\<^sub>d\<^sub>d\<^sub>r' sz\<^sub>a\<^sub>d\<^sub>d\<^sub>r sz e v en \<Rightarrow> \<open>rule REDUCE[of _ _ \<open>e @ (v[num\<^sub>a\<^sub>d\<^sub>d\<^sub>r' \<Colon> sz\<^sub>a\<^sub>d\<^sub>d\<^sub>r \<leftarrow> num\<^sub>1 \<Colon> sz, sz][num\<^sub>a\<^sub>d\<^sub>d\<^sub>r \<Colon> sz\<^sub>a\<^sub>d\<^sub>d\<^sub>r, en]:usz)\<close>], solve_exp, solve_exps\<close>

(*  \<bar> \<open>_ \<turnstile> (v[num\<^sub>2 \<Colon> sz\<^sub>a\<^sub>d\<^sub>d\<^sub>r \<leftarrow> num\<^sub>1 \<Colon> sz\<^sub>m\<^sub>e\<^sub>m, sz\<^sub>m\<^sub>e\<^sub>m][succ (num\<^sub>3 \<Colon> sz\<^sub>a\<^sub>d\<^sub>d\<^sub>r), el]:usz - sz\<^sub>m\<^sub>e\<^sub>m) @ (v[num\<^sub>2 \<Colon> sz\<^sub>a\<^sub>d\<^sub>d\<^sub>r \<leftarrow> num\<^sub>1 \<Colon> sz\<^sub>m\<^sub>e\<^sub>m, sz\<^sub>m\<^sub>e\<^sub>m][num\<^sub>3 \<Colon> sz\<^sub>a\<^sub>d\<^sub>d\<^sub>r, el]:usz\<^sub>m\<^sub>e\<^sub>m) \<leadsto>* _\<close> for num\<^sub>1 num\<^sub>2 num\<^sub>3 sz\<^sub>a\<^sub>d\<^sub>d\<^sub>r sz\<^sub>m\<^sub>e\<^sub>m sz v \<Rightarrow> \<open>rule REDUCE[of _ _ \<open>(v[num\<^sub>2 \<Colon> sz\<^sub>a\<^sub>d\<^sub>d\<^sub>r \<leftarrow> num\<^sub>1 \<Colon> sz\<^sub>m\<^sub>e\<^sub>m, sz\<^sub>m\<^sub>e\<^sub>m][succ (num\<^sub>3 \<Colon> sz\<^sub>a\<^sub>d\<^sub>d\<^sub>r), el]:usz - sz\<^sub>m\<^sub>e\<^sub>m) @ (num\<^sub>1 \<Colon> sz\<^sub>m\<^sub>e\<^sub>m)\<close>], solve_exp\<close> *)


   \<comment> \<open>LOAD_EL\<close>
  \<bar> \<open>_ \<turnstile> (((((v[num\<^sub>a\<^sub>d\<^sub>d\<^sub>r' \<Colon> sz\<^sub>a\<^sub>d\<^sub>d\<^sub>r \<leftarrow> num \<Colon> sz\<^sub>m\<^sub>e\<^sub>m, sz\<^sub>m\<^sub>e\<^sub>m][num\<^sub>a\<^sub>d\<^sub>d\<^sub>r \<Colon> sz\<^sub>a\<^sub>d\<^sub>d\<^sub>r, el]:usz @ (num\<^sub>6 \<Colon> sz\<^sub>m\<^sub>e\<^sub>m)) @ (num\<^sub>5 \<Colon> sz\<^sub>m\<^sub>e\<^sub>m)) @ (num\<^sub>4 \<Colon> sz\<^sub>m\<^sub>e\<^sub>m)) @ (num\<^sub>3 \<Colon> sz\<^sub>m\<^sub>e\<^sub>m)) @ (num\<^sub>2 \<Colon> sz\<^sub>m\<^sub>e\<^sub>m)) @ (num\<^sub>1 \<Colon> sz\<^sub>m\<^sub>e\<^sub>m) \<leadsto>* _\<close>  for v num\<^sub>a\<^sub>d\<^sub>d\<^sub>r' sz\<^sub>a\<^sub>d\<^sub>d\<^sub>r num sz\<^sub>m\<^sub>e\<^sub>m num\<^sub>a\<^sub>d\<^sub>d\<^sub>r sz num\<^sub>6 num\<^sub>5 num\<^sub>4 num\<^sub>3 num\<^sub>2 num\<^sub>1 \<Rightarrow> \<open>rule REDUCE[of _ _ \<open>((((((v[num\<^sub>a\<^sub>d\<^sub>d\<^sub>r' \<Colon> sz\<^sub>a\<^sub>d\<^sub>d\<^sub>r \<leftarrow> num \<Colon> sz\<^sub>m\<^sub>e\<^sub>m, sz\<^sub>m\<^sub>e\<^sub>m][succ (num\<^sub>a\<^sub>d\<^sub>d\<^sub>r \<Colon> sz\<^sub>a\<^sub>d\<^sub>d\<^sub>r), el]:usz - sz\<^sub>m\<^sub>e\<^sub>m @ (v[num\<^sub>a\<^sub>d\<^sub>d\<^sub>r' \<Colon> sz\<^sub>a\<^sub>d\<^sub>d\<^sub>r \<leftarrow> num \<Colon> sz\<^sub>m\<^sub>e\<^sub>m, sz\<^sub>m\<^sub>e\<^sub>m][num\<^sub>a\<^sub>d\<^sub>d\<^sub>r \<Colon> sz\<^sub>a\<^sub>d\<^sub>d\<^sub>r, el]:usz\<^sub>m\<^sub>e\<^sub>m)) @ (num\<^sub>6 \<Colon> sz\<^sub>m\<^sub>e\<^sub>m)) @ (num\<^sub>5 \<Colon> sz\<^sub>m\<^sub>e\<^sub>m)) @ (num\<^sub>4 \<Colon> sz\<^sub>m\<^sub>e\<^sub>m)) @ (num\<^sub>3 \<Colon> sz\<^sub>m\<^sub>e\<^sub>m)) @ (num\<^sub>2 \<Colon> sz\<^sub>m\<^sub>e\<^sub>m)) @ (num\<^sub>1 \<Colon> sz\<^sub>m\<^sub>e\<^sub>m)\<close>], solve_exp, solve_exps\<close>
  \<bar> \<open>_ \<turnstile> ((((v[num\<^sub>a\<^sub>d\<^sub>d\<^sub>r' \<Colon> sz\<^sub>a\<^sub>d\<^sub>d\<^sub>r \<leftarrow> num \<Colon> sz\<^sub>m\<^sub>e\<^sub>m, sz\<^sub>m\<^sub>e\<^sub>m][num\<^sub>a\<^sub>d\<^sub>d\<^sub>r \<Colon> sz\<^sub>a\<^sub>d\<^sub>d\<^sub>r, el]:usz @ (num\<^sub>5 \<Colon> sz\<^sub>m\<^sub>e\<^sub>m)) @ (num\<^sub>4 \<Colon> sz\<^sub>m\<^sub>e\<^sub>m)) @ (num\<^sub>3 \<Colon> sz\<^sub>m\<^sub>e\<^sub>m)) @ (num\<^sub>2 \<Colon> sz\<^sub>m\<^sub>e\<^sub>m)) @ (num\<^sub>1 \<Colon> sz\<^sub>m\<^sub>e\<^sub>m) \<leadsto>* _\<close>  for v num\<^sub>a\<^sub>d\<^sub>d\<^sub>r' sz\<^sub>a\<^sub>d\<^sub>d\<^sub>r num sz\<^sub>m\<^sub>e\<^sub>m num\<^sub>a\<^sub>d\<^sub>d\<^sub>r sz num\<^sub>5 num\<^sub>4 num\<^sub>3 num\<^sub>2 num\<^sub>1 \<Rightarrow> \<open>rule REDUCE[of _ _ \<open>((((((v[num\<^sub>a\<^sub>d\<^sub>d\<^sub>r' \<Colon> sz\<^sub>a\<^sub>d\<^sub>d\<^sub>r \<leftarrow> num \<Colon> sz\<^sub>m\<^sub>e\<^sub>m, sz\<^sub>m\<^sub>e\<^sub>m][succ (num\<^sub>a\<^sub>d\<^sub>d\<^sub>r \<Colon> sz\<^sub>a\<^sub>d\<^sub>d\<^sub>r), el]:usz - sz\<^sub>m\<^sub>e\<^sub>m @ (v[num\<^sub>a\<^sub>d\<^sub>d\<^sub>r' \<Colon> sz\<^sub>a\<^sub>d\<^sub>d\<^sub>r \<leftarrow> num \<Colon> sz\<^sub>m\<^sub>e\<^sub>m, sz\<^sub>m\<^sub>e\<^sub>m][num\<^sub>a\<^sub>d\<^sub>d\<^sub>r \<Colon> sz\<^sub>a\<^sub>d\<^sub>d\<^sub>r, el]:usz\<^sub>m\<^sub>e\<^sub>m))) @ (num\<^sub>5 \<Colon> sz\<^sub>m\<^sub>e\<^sub>m)) @ (num\<^sub>4 \<Colon> sz\<^sub>m\<^sub>e\<^sub>m)) @ (num\<^sub>3 \<Colon> sz\<^sub>m\<^sub>e\<^sub>m)) @ (num\<^sub>2 \<Colon> sz\<^sub>m\<^sub>e\<^sub>m)) @ (num\<^sub>1 \<Colon> sz\<^sub>m\<^sub>e\<^sub>m)\<close>], solve_exp, solve_exps\<close>
  \<bar> \<open>_ \<turnstile> (((v[num\<^sub>a\<^sub>d\<^sub>d\<^sub>r' \<Colon> sz\<^sub>a\<^sub>d\<^sub>d\<^sub>r \<leftarrow> num \<Colon> sz\<^sub>m\<^sub>e\<^sub>m, sz\<^sub>m\<^sub>e\<^sub>m][num\<^sub>a\<^sub>d\<^sub>d\<^sub>r \<Colon> sz\<^sub>a\<^sub>d\<^sub>d\<^sub>r, el]:usz @ (num\<^sub>4 \<Colon> sz\<^sub>m\<^sub>e\<^sub>m)) @ (num\<^sub>3 \<Colon> sz\<^sub>m\<^sub>e\<^sub>m)) @ (num\<^sub>2 \<Colon> sz\<^sub>m\<^sub>e\<^sub>m)) @ (num\<^sub>1 \<Colon> sz\<^sub>m\<^sub>e\<^sub>m) \<leadsto>* _\<close>  for v num\<^sub>a\<^sub>d\<^sub>d\<^sub>r' sz\<^sub>a\<^sub>d\<^sub>d\<^sub>r num sz\<^sub>m\<^sub>e\<^sub>m num\<^sub>a\<^sub>d\<^sub>d\<^sub>r sz num\<^sub>4 num\<^sub>3 num\<^sub>2 num\<^sub>1 \<Rightarrow> \<open>rule REDUCE[of _ _ \<open>(((((v[num\<^sub>a\<^sub>d\<^sub>d\<^sub>r' \<Colon> sz\<^sub>a\<^sub>d\<^sub>d\<^sub>r \<leftarrow> num \<Colon> sz\<^sub>m\<^sub>e\<^sub>m, sz\<^sub>m\<^sub>e\<^sub>m][succ (num\<^sub>a\<^sub>d\<^sub>d\<^sub>r \<Colon> sz\<^sub>a\<^sub>d\<^sub>d\<^sub>r), el]:usz - sz\<^sub>m\<^sub>e\<^sub>m @ (v[num\<^sub>a\<^sub>d\<^sub>d\<^sub>r' \<Colon> sz\<^sub>a\<^sub>d\<^sub>d\<^sub>r \<leftarrow> num \<Colon> sz\<^sub>m\<^sub>e\<^sub>m, sz\<^sub>m\<^sub>e\<^sub>m][num\<^sub>a\<^sub>d\<^sub>d\<^sub>r \<Colon> sz\<^sub>a\<^sub>d\<^sub>d\<^sub>r, el]:usz\<^sub>m\<^sub>e\<^sub>m))) @ (num\<^sub>4 \<Colon> sz\<^sub>m\<^sub>e\<^sub>m)) @ (num\<^sub>3 \<Colon> sz\<^sub>m\<^sub>e\<^sub>m)) @ (num\<^sub>2 \<Colon> sz\<^sub>m\<^sub>e\<^sub>m)) @ (num\<^sub>1 \<Colon> sz\<^sub>m\<^sub>e\<^sub>m)\<close>], solve_exp, solve_exps\<close>
  \<bar> \<open>_ \<turnstile> ((v[num\<^sub>a\<^sub>d\<^sub>d\<^sub>r' \<Colon> sz\<^sub>a\<^sub>d\<^sub>d\<^sub>r \<leftarrow> num \<Colon> sz\<^sub>m\<^sub>e\<^sub>m, sz\<^sub>m\<^sub>e\<^sub>m][num\<^sub>a\<^sub>d\<^sub>d\<^sub>r \<Colon> sz\<^sub>a\<^sub>d\<^sub>d\<^sub>r, el]:usz @ (num\<^sub>3 \<Colon> sz\<^sub>m\<^sub>e\<^sub>m)) @ (num\<^sub>2 \<Colon> sz\<^sub>m\<^sub>e\<^sub>m)) @ (num\<^sub>1 \<Colon> sz\<^sub>m\<^sub>e\<^sub>m) \<leadsto>* _\<close>  for v num\<^sub>a\<^sub>d\<^sub>d\<^sub>r' sz\<^sub>a\<^sub>d\<^sub>d\<^sub>r num sz\<^sub>m\<^sub>e\<^sub>m num\<^sub>a\<^sub>d\<^sub>d\<^sub>r sz num\<^sub>3 num\<^sub>2 num\<^sub>1 \<Rightarrow> \<open>rule REDUCE[of _ _ \<open>((((v[num\<^sub>a\<^sub>d\<^sub>d\<^sub>r' \<Colon> sz\<^sub>a\<^sub>d\<^sub>d\<^sub>r \<leftarrow> num \<Colon> sz\<^sub>m\<^sub>e\<^sub>m, sz\<^sub>m\<^sub>e\<^sub>m][succ (num\<^sub>a\<^sub>d\<^sub>d\<^sub>r \<Colon> sz\<^sub>a\<^sub>d\<^sub>d\<^sub>r), el]:usz - sz\<^sub>m\<^sub>e\<^sub>m @ (v[num\<^sub>a\<^sub>d\<^sub>d\<^sub>r' \<Colon> sz\<^sub>a\<^sub>d\<^sub>d\<^sub>r \<leftarrow> num \<Colon> sz\<^sub>m\<^sub>e\<^sub>m, sz\<^sub>m\<^sub>e\<^sub>m][num\<^sub>a\<^sub>d\<^sub>d\<^sub>r \<Colon> sz\<^sub>a\<^sub>d\<^sub>d\<^sub>r, el]:usz\<^sub>m\<^sub>e\<^sub>m))) @ (num\<^sub>3 \<Colon> sz\<^sub>m\<^sub>e\<^sub>m)) @ (num\<^sub>2 \<Colon> sz\<^sub>m\<^sub>e\<^sub>m)) @ (num\<^sub>1 \<Colon> sz\<^sub>m\<^sub>e\<^sub>m)\<close>], solve_exp, solve_exps\<close>
  \<bar> \<open>_ \<turnstile> (v[num\<^sub>a\<^sub>d\<^sub>d\<^sub>r' \<Colon> sz\<^sub>a\<^sub>d\<^sub>d\<^sub>r \<leftarrow> num \<Colon> sz\<^sub>m\<^sub>e\<^sub>m, sz\<^sub>m\<^sub>e\<^sub>m][num\<^sub>a\<^sub>d\<^sub>d\<^sub>r \<Colon> sz\<^sub>a\<^sub>d\<^sub>d\<^sub>r, el]:usz @ (num\<^sub>2 \<Colon> sz\<^sub>m\<^sub>e\<^sub>m)) @ (num\<^sub>1 \<Colon> sz\<^sub>m\<^sub>e\<^sub>m) \<leadsto>* _\<close>  for v num\<^sub>a\<^sub>d\<^sub>d\<^sub>r' sz\<^sub>a\<^sub>d\<^sub>d\<^sub>r num sz\<^sub>m\<^sub>e\<^sub>m num\<^sub>a\<^sub>d\<^sub>d\<^sub>r sz num\<^sub>2 num\<^sub>1 \<Rightarrow> \<open>rule REDUCE[of _ _ \<open>(((v[num\<^sub>a\<^sub>d\<^sub>d\<^sub>r' \<Colon> sz\<^sub>a\<^sub>d\<^sub>d\<^sub>r \<leftarrow> num \<Colon> sz\<^sub>m\<^sub>e\<^sub>m, sz\<^sub>m\<^sub>e\<^sub>m][succ (num\<^sub>a\<^sub>d\<^sub>d\<^sub>r \<Colon> sz\<^sub>a\<^sub>d\<^sub>d\<^sub>r), el]:usz - sz\<^sub>m\<^sub>e\<^sub>m @ (v[num\<^sub>a\<^sub>d\<^sub>d\<^sub>r' \<Colon> sz\<^sub>a\<^sub>d\<^sub>d\<^sub>r \<leftarrow> num \<Colon> sz\<^sub>m\<^sub>e\<^sub>m, sz\<^sub>m\<^sub>e\<^sub>m][num\<^sub>a\<^sub>d\<^sub>d\<^sub>r \<Colon> sz\<^sub>a\<^sub>d\<^sub>d\<^sub>r, el]:usz\<^sub>m\<^sub>e\<^sub>m))) @ (num\<^sub>2 \<Colon> sz\<^sub>m\<^sub>e\<^sub>m)) @ (num\<^sub>1 \<Colon> sz\<^sub>m\<^sub>e\<^sub>m)\<close>], solve_exp, solve_exps\<close>
  \<bar> \<open>_ \<turnstile> v[num\<^sub>a\<^sub>d\<^sub>d\<^sub>r' \<Colon> sz\<^sub>a\<^sub>d\<^sub>d\<^sub>r \<leftarrow> num \<Colon> sz\<^sub>m\<^sub>e\<^sub>m, sz\<^sub>m\<^sub>e\<^sub>m][num\<^sub>a\<^sub>d\<^sub>d\<^sub>r \<Colon> sz\<^sub>a\<^sub>d\<^sub>d\<^sub>r, el]:usz @ (num\<^sub>1 \<Colon> sz\<^sub>m\<^sub>e\<^sub>m) \<leadsto>* _\<close>  for v num\<^sub>a\<^sub>d\<^sub>d\<^sub>r' sz\<^sub>a\<^sub>d\<^sub>d\<^sub>r num sz\<^sub>m\<^sub>e\<^sub>m num\<^sub>a\<^sub>d\<^sub>d\<^sub>r sz num\<^sub>1 \<Rightarrow> \<open>rule REDUCE[of _ _ \<open>((v[num\<^sub>a\<^sub>d\<^sub>d\<^sub>r' \<Colon> sz\<^sub>a\<^sub>d\<^sub>d\<^sub>r \<leftarrow> num \<Colon> sz\<^sub>m\<^sub>e\<^sub>m, sz\<^sub>m\<^sub>e\<^sub>m][succ (num\<^sub>a\<^sub>d\<^sub>d\<^sub>r \<Colon> sz\<^sub>a\<^sub>d\<^sub>d\<^sub>r), el]:usz - sz\<^sub>m\<^sub>e\<^sub>m @ (v[num\<^sub>a\<^sub>d\<^sub>d\<^sub>r' \<Colon> sz\<^sub>a\<^sub>d\<^sub>d\<^sub>r \<leftarrow> num \<Colon> sz\<^sub>m\<^sub>e\<^sub>m, sz\<^sub>m\<^sub>e\<^sub>m][num\<^sub>a\<^sub>d\<^sub>d\<^sub>r \<Colon> sz\<^sub>a\<^sub>d\<^sub>d\<^sub>r, el]:usz\<^sub>m\<^sub>e\<^sub>m))) @ (num\<^sub>1 \<Colon> sz\<^sub>m\<^sub>e\<^sub>m)\<close>], solve_exp, solve_exps\<close>
  \<bar> \<open>_ \<turnstile> v[num\<^sub>2 \<Colon> sz\<^sub>a\<^sub>d\<^sub>d\<^sub>r \<leftarrow> num\<^sub>1 \<Colon> sz\<^sub>m\<^sub>e\<^sub>m, sz\<^sub>m\<^sub>e\<^sub>m][num\<^sub>3 \<Colon> sz\<^sub>a\<^sub>d\<^sub>d\<^sub>r, el]:usz \<leadsto>* _\<close> for num\<^sub>1 num\<^sub>2 num\<^sub>3 sz\<^sub>a\<^sub>d\<^sub>d\<^sub>r sz\<^sub>m\<^sub>e\<^sub>m sz v \<Rightarrow> \<open>rule REDUCE[of _ _ \<open>(v[num\<^sub>2 \<Colon> sz\<^sub>a\<^sub>d\<^sub>d\<^sub>r \<leftarrow> num\<^sub>1 \<Colon> sz\<^sub>m\<^sub>e\<^sub>m, sz\<^sub>m\<^sub>e\<^sub>m][succ (num\<^sub>3 \<Colon> sz\<^sub>a\<^sub>d\<^sub>d\<^sub>r), el]:usz - sz\<^sub>m\<^sub>e\<^sub>m) @ (v[num\<^sub>2 \<Colon> sz\<^sub>a\<^sub>d\<^sub>d\<^sub>r \<leftarrow> num\<^sub>1 \<Colon> sz\<^sub>m\<^sub>e\<^sub>m, sz\<^sub>m\<^sub>e\<^sub>m][num\<^sub>3 \<Colon> sz\<^sub>a\<^sub>d\<^sub>d\<^sub>r, el]:usz\<^sub>m\<^sub>e\<^sub>m)\<close>], solve_exp, solve_exps\<close>

    \<comment> \<open>Reducible Store\<close>


  \<bar> \<open>_ \<turnstile> v[num\<^sub>1 \<Colon> sz\<^sub>a\<^sub>d\<^sub>d\<^sub>r \<leftarrow> num\<^sub>2 \<Colon> sz\<^sub>m\<^sub>e\<^sub>m, sz\<^sub>m\<^sub>e\<^sub>m] with [num\<^sub>3 \<Colon> sz\<^sub>a\<^sub>d\<^sub>d\<^sub>r, _]:usz\<^sub>m\<^sub>e\<^sub>m \<leftarrow> (num\<^sub>4 \<Colon> sz\<^sub>m\<^sub>e\<^sub>m) \<leadsto>* _\<close> for v num\<^sub>1 num\<^sub>2 num\<^sub>3 num\<^sub>4 sz\<^sub>m\<^sub>e\<^sub>m sz\<^sub>a\<^sub>d\<^sub>d\<^sub>r \<Rightarrow> \<open>rule REDUCE[of _ _ \<open>v[num\<^sub>1 \<Colon> sz\<^sub>a\<^sub>d\<^sub>d\<^sub>r \<leftarrow> num\<^sub>2 \<Colon> sz\<^sub>m\<^sub>e\<^sub>m, sz\<^sub>m\<^sub>e\<^sub>m][num\<^sub>3 \<Colon> sz\<^sub>a\<^sub>d\<^sub>d\<^sub>r \<leftarrow> num\<^sub>4 \<Colon> sz\<^sub>m\<^sub>e\<^sub>m, sz\<^sub>m\<^sub>e\<^sub>m]\<close>], solve_exp, solve_exps\<close>
  \<bar> \<open>_ \<turnstile> (v[num\<^sub>1 \<Colon> sz\<^sub>a\<^sub>d\<^sub>d\<^sub>r \<leftarrow> num\<^sub>2 \<Colon> sz\<^sub>m\<^sub>e\<^sub>m, sz\<^sub>m\<^sub>e\<^sub>m] with [num\<^sub>3 \<Colon> sz\<^sub>a\<^sub>d\<^sub>d\<^sub>r, el]:usz\<^sub>m\<^sub>e\<^sub>m \<leftarrow> low:sz\<^sub>m\<^sub>e\<^sub>m[num\<^sub>4 \<Colon> sz\<^sub>1]) with [num\<^sub>5 \<Colon> sz\<^sub>a\<^sub>d\<^sub>d\<^sub>r, el]:usz\<^sub>2 \<leftarrow> num\<^sub>6 \<Colon> sz\<^sub>2 \<leadsto>* _\<close> for v num\<^sub>1 num\<^sub>2 num\<^sub>3 num\<^sub>4 num\<^sub>5 num\<^sub>6 sz\<^sub>a\<^sub>d\<^sub>d\<^sub>r sz\<^sub>m\<^sub>e\<^sub>m sz\<^sub>1 sz\<^sub>2 \<Rightarrow> \<open>rule REDUCE[of _ _ \<open>(v[num\<^sub>1 \<Colon> sz\<^sub>a\<^sub>d\<^sub>d\<^sub>r \<leftarrow> num\<^sub>2 \<Colon> sz\<^sub>m\<^sub>e\<^sub>m, sz\<^sub>m\<^sub>e\<^sub>m] with [num\<^sub>3 \<Colon> sz\<^sub>a\<^sub>d\<^sub>d\<^sub>r, el]:usz\<^sub>m\<^sub>e\<^sub>m \<leftarrow> (ext (num\<^sub>4 \<Colon> sz\<^sub>1) \<sim> hi : sz\<^sub>m\<^sub>e\<^sub>m - 1 \<sim> lo : 0)) with [num\<^sub>5 \<Colon> sz\<^sub>a\<^sub>d\<^sub>d\<^sub>r, el]:usz\<^sub>2 \<leftarrow> num\<^sub>6 \<Colon> sz\<^sub>2\<close>], solve_exp, solve_exps\<close>
...
(*  \<bar> \<open>\<Delta> \<turnstile> e\<^sub>1 with [(var :\<^sub>t t) + (num\<^sub>1 \<Colon> sz\<^sub>1), en]:usz\<^sub>2 \<leftarrow> (Val v) \<leadsto>* _\<close> for \<Delta> e\<^sub>1 var t num\<^sub>1 sz\<^sub>1 en sz\<^sub>2 v \<Rightarrow> \<open>rule REDUCE[of _ _ \<open>e\<^sub>1 with [(Val (the (\<Delta> (var :\<^sub>t t)))) + (num\<^sub>1 \<Colon> sz\<^sub>1), en]:usz\<^sub>2 \<leftarrow> Val v\<close>], solve_exp, rule var_in_val_the_var, assumption?, (unfold in_vars_the_simp)?, solve_exps\<close>*)
  ...
  \<bar> \<open>\<Delta> \<turnstile> e\<^sub>1 with [(num\<^sub>1 \<Colon> sz\<^sub>1) + (num\<^sub>2 \<Colon> sz\<^sub>2), en]:usz\<^sub>3 \<leftarrow> (num\<^sub>3 \<Colon> sz\<^sub>3) \<leadsto>* _\<close> for \<Delta> e\<^sub>1 num\<^sub>1 sz\<^sub>1 num\<^sub>2 sz\<^sub>2 en num\<^sub>3 sz\<^sub>3 \<Rightarrow> \<open>rule REDUCE[of _ _ \<open>e\<^sub>1 with [(num\<^sub>1 \<Colon> sz\<^sub>1) +\<^sub>b\<^sub>v (num\<^sub>2 \<Colon> sz\<^sub>2), en]:usz\<^sub>3 \<leftarrow> (num\<^sub>3 \<Colon> sz\<^sub>3)\<close>], solve_exp, unfold bv_plus.simps, simp del: dvd_imp_mod_0 mod_less, solve_exps\<close>
  ...
  \<bar> \<open>_ \<turnstile> e\<^sub>1 with [e\<^sub>2, en]:usz \<leftarrow> (low:sz[num\<^sub>1 \<Colon> sz\<^sub>1]) \<leadsto>* _\<close> for e\<^sub>1 e\<^sub>2 en sz num\<^sub>1 sz\<^sub>1 \<Rightarrow> \<open>rule REDUCE[of _ _ \<open>e\<^sub>1 with [e\<^sub>2, en]:usz \<leftarrow> ext num\<^sub>1 \<Colon> sz\<^sub>1 \<sim> hi : sz - 1 \<sim> lo : 0\<close>], solve_exp, solve_exps\<close>
  \<bar> \<open>_ \<turnstile> e\<^sub>1 with [e\<^sub>2, en]:usz \<leftarrow> (high:sz[val \<Colon> sz']) \<leadsto>* _\<close> for e\<^sub>1 e\<^sub>2 en sz val sz' \<Rightarrow> \<open>rule REDUCE[of _ _ \<open>e\<^sub>1 with [e\<^sub>2, el]:usz \<leftarrow> (ext val \<Colon> sz' \<sim> hi : sz' - 1 \<sim> lo : sz' - sz)\<close>], solve_exp, solve_exps\<close>
(*  \<bar> \<open>_ \<turnstile> ((v[num\<^sub>a \<Colon> sz\<^sub>a \<leftarrow> num\<^sub>v \<Colon> sz\<^sub>v, sz\<^sub>v]) with [num\<^sub>1 \<Colon> sz\<^sub>1, en]:usz\<^sub>2 \<leftarrow> (num\<^sub>2 \<Colon> sz\<^sub>2)) with [num3 \<Colon> sz3, en]:usz4 \<leftarrow> (num5 \<Colon> sz5) \<leadsto>* _\<close> for num\<^sub>a num\<^sub>v sz\<^sub>a sz\<^sub>v v num\<^sub>1 sz\<^sub>1 en num\<^sub>2 sz\<^sub>2 num3 sz3 sz4 num5 sz5 \<Rightarrow> \<open>rule REDUCE[of _ _ \<open>((v[num\<^sub>a \<Colon> sz\<^sub>a \<leftarrow> num\<^sub>v \<Colon> sz\<^sub>v, sz\<^sub>v])[(num\<^sub>1 \<Colon> sz\<^sub>1) \<leftarrow> (num\<^sub>2 \<Colon> sz\<^sub>2), sz\<^sub>2]) with [num3 \<Colon> sz3, en]:usz4 \<leftarrow> (num5 \<Colon> sz5)\<close>], solve_exp, solve_exps\<close>*)
(*  \<bar> \<open>_ \<turnstile> ((Val v) with [num\<^sub>1 \<Colon> sz\<^sub>1, en]:usz\<^sub>2 \<leftarrow> (num\<^sub>2 \<Colon> sz\<^sub>2)) with [num3 \<Colon> sz3, en]:usz4 \<leftarrow> (num5 \<Colon> sz5) \<leadsto>* _\<close> for v num\<^sub>1 sz\<^sub>1 en num\<^sub>2 sz\<^sub>2 num3 sz3 sz4 num5 sz5 \<Rightarrow> \<open>rule REDUCE[of _ _ \<open>(v[(num\<^sub>1 \<Colon> sz\<^sub>1) \<leftarrow> (num\<^sub>2 \<Colon> sz\<^sub>2), sz\<^sub>2]) with [num3 \<Colon> sz3, en]:usz4 \<leftarrow> (num5 \<Colon> sz5)\<close>], solve_exp, solve_exps\<close>*)
(*  \<bar> \<open>_ \<turnstile> v[num\<^sub>1 \<Colon> sz\<^sub>a\<^sub>d\<^sub>d\<^sub>r \<leftarrow> num\<^sub>2 \<Colon> sz\<^sub>m\<^sub>e\<^sub>m, sz\<^sub>m\<^sub>e\<^sub>m] with [num\<^sub>3 \<Colon> sz\<^sub>a\<^sub>d\<^sub>d\<^sub>r, el]:usz \<leftarrow> num\<^sub>4 \<Colon> sz \<leadsto>* _\<close> for v num\<^sub>1 sz\<^sub>a\<^sub>d\<^sub>d\<^sub>r num\<^sub>2 sz\<^sub>m\<^sub>e\<^sub>m num\<^sub>3 sz num\<^sub>4 \<Rightarrow> \<open>rule REDUCE[of _ _ \<open>(v[num\<^sub>1 \<Colon> sz\<^sub>a\<^sub>d\<^sub>d\<^sub>r \<leftarrow> num\<^sub>2 \<Colon> sz\<^sub>m\<^sub>e\<^sub>m, sz\<^sub>m\<^sub>e\<^sub>m] with [num\<^sub>3 \<Colon> sz\<^sub>a\<^sub>d\<^sub>d\<^sub>r, el]:u8 \<leftarrow> low:8[num\<^sub>4 \<Colon> sz]) with [succ (num\<^sub>3 \<Colon> sz\<^sub>a\<^sub>d\<^sub>d\<^sub>r), el]:usz - sz\<^sub>m\<^sub>e\<^sub>m \<leftarrow> high:sz - sz\<^sub>m\<^sub>e\<^sub>m[num\<^sub>4 \<Colon> sz]\<close>], solve_exp, solve_exps\<close>*)

    \<comment> \<open>Reducible Concat\<close>
  \<bar> \<open>_ \<turnstile> (((((((num\<^sub>1 \<Colon> sz\<^sub>1) @ (num\<^sub>2 \<Colon> sz\<^sub>2)) @ (num\<^sub>3 \<Colon> sz\<^sub>3)) @ (num\<^sub>4 \<Colon> sz\<^sub>4)) @ (num\<^sub>5 \<Colon> sz\<^sub>5)) @ (num\<^sub>6 \<Colon> sz\<^sub>6)) @ (num\<^sub>7 \<Colon> sz\<^sub>7)) @ (num\<^sub>8 \<Colon> sz\<^sub>8) \<leadsto>* _\<close> for num\<^sub>1 num\<^sub>2 num\<^sub>3 num\<^sub>4 num\<^sub>5 num\<^sub>6 num\<^sub>7 num\<^sub>8 sz\<^sub>1 sz\<^sub>2 sz\<^sub>3 sz\<^sub>4 sz\<^sub>5 sz\<^sub>6 sz\<^sub>7 sz\<^sub>8 \<Rightarrow> \<open>rule REDUCE[of _ _ \<open>(((((((num\<^sub>1 \<Colon> sz\<^sub>1) \<cdot> (num\<^sub>2 \<Colon> sz\<^sub>2)) @ (num\<^sub>3 \<Colon> sz\<^sub>3)) @ (num\<^sub>4 \<Colon> sz\<^sub>4)) @ (num\<^sub>5 \<Colon> sz\<^sub>5)) @ (num\<^sub>6 \<Colon> sz\<^sub>6)) @ (num\<^sub>7 \<Colon> sz\<^sub>7)) @ (num\<^sub>8 \<Colon> sz\<^sub>8)\<close>], solve_exp, unfold bv_concat.simps, simp (no_asm) del: dvd_imp_mod_0 mod_less, solve_exps\<close>
  \<bar> \<open>_ \<turnstile> ((((((num\<^sub>1 \<Colon> sz\<^sub>1) @ (num\<^sub>2 \<Colon> sz\<^sub>2)) @ (num\<^sub>3 \<Colon> sz\<^sub>3)) @ (num\<^sub>4 \<Colon> sz\<^sub>4)) @ (num\<^sub>5 \<Colon> sz\<^sub>5)) @ (num\<^sub>6 \<Colon> sz\<^sub>6)) @ (num\<^sub>7 \<Colon> sz\<^sub>7) \<leadsto>* _\<close> for num\<^sub>1 num\<^sub>2 num\<^sub>3 num\<^sub>4 num\<^sub>5 num\<^sub>6 num\<^sub>7 sz\<^sub>1 sz\<^sub>2 sz\<^sub>3 sz\<^sub>4 sz\<^sub>5 sz\<^sub>6 sz\<^sub>7 \<Rightarrow> \<open>rule REDUCE[of _ _ \<open>((((((num\<^sub>1 \<Colon> sz\<^sub>1) \<cdot> (num\<^sub>2 \<Colon> sz\<^sub>2)) @ (num\<^sub>3 \<Colon> sz\<^sub>3)) @ (num\<^sub>4 \<Colon> sz\<^sub>4)) @ (num\<^sub>5 \<Colon> sz\<^sub>5)) @ (num\<^sub>6 \<Colon> sz\<^sub>6)) @ (num\<^sub>7 \<Colon> sz\<^sub>7)\<close>], solve_exp, unfold bv_concat.simps, simp (no_asm) del: dvd_imp_mod_0 mod_less, solve_exps\<close>
  \<bar> \<open>_ \<turnstile> (((((num\<^sub>1 \<Colon> sz\<^sub>1) @ (num\<^sub>2 \<Colon> sz\<^sub>2)) @ (num\<^sub>3 \<Colon> sz\<^sub>3)) @ (num\<^sub>4 \<Colon> sz\<^sub>4)) @ (num\<^sub>5 \<Colon> sz\<^sub>5)) @ (num\<^sub>6 \<Colon> sz\<^sub>6) \<leadsto>* _\<close> for num\<^sub>1 num\<^sub>2 num\<^sub>3 num\<^sub>4 num\<^sub>5 num\<^sub>6 sz\<^sub>1 sz\<^sub>2 sz\<^sub>3 sz\<^sub>4 sz\<^sub>5 sz\<^sub>6 \<Rightarrow> \<open>rule REDUCE[of _ _ \<open>(((((num\<^sub>1 \<Colon> sz\<^sub>1) \<cdot> (num\<^sub>2 \<Colon> sz\<^sub>2)) @ (num\<^sub>3 \<Colon> sz\<^sub>3)) @ (num\<^sub>4 \<Colon> sz\<^sub>4)) @ (num\<^sub>5 \<Colon> sz\<^sub>5)) @ (num\<^sub>6 \<Colon> sz\<^sub>6)\<close>], solve_exp, unfold bv_concat.simps, simp (no_asm) del: dvd_imp_mod_0 mod_less, solve_exps\<close>
  \<bar> \<open>_ \<turnstile> ((((num\<^sub>1 \<Colon> sz\<^sub>1) @ (num\<^sub>2 \<Colon> sz\<^sub>2)) @ (num\<^sub>3 \<Colon> sz\<^sub>3)) @ (num\<^sub>4 \<Colon> sz\<^sub>4)) @ (num\<^sub>5 \<Colon> sz\<^sub>5) \<leadsto>* _\<close> for num\<^sub>1 num\<^sub>2 num\<^sub>3 num\<^sub>4 num\<^sub>5 sz\<^sub>1 sz\<^sub>2 sz\<^sub>3 sz\<^sub>4 sz\<^sub>5 \<Rightarrow> \<open>rule REDUCE[of _ _ \<open>((((num\<^sub>1 \<Colon> sz\<^sub>1) \<cdot> (num\<^sub>2 \<Colon> sz\<^sub>2)) @ (num\<^sub>3 \<Colon> sz\<^sub>3)) @ (num\<^sub>4 \<Colon> sz\<^sub>4)) @ (num\<^sub>5 \<Colon> sz\<^sub>5)\<close>], solve_exp, unfold bv_concat.simps, simp (no_asm) del: dvd_imp_mod_0 mod_less, solve_exps\<close>
  \<bar> \<open>_ \<turnstile> (((num\<^sub>1 \<Colon> sz\<^sub>1) @ (num\<^sub>2 \<Colon> sz\<^sub>2)) @ (num\<^sub>3 \<Colon> sz\<^sub>3)) @ (num\<^sub>4 \<Colon> sz\<^sub>4) \<leadsto>* _\<close> for num\<^sub>1 num\<^sub>2 num\<^sub>3 num\<^sub>4 sz\<^sub>1 sz\<^sub>2 sz\<^sub>3 sz\<^sub>4 \<Rightarrow> \<open>rule REDUCE[of _ _ \<open>(((num\<^sub>1 \<Colon> sz\<^sub>1) \<cdot> (num\<^sub>2 \<Colon> sz\<^sub>2)) @ (num\<^sub>3 \<Colon> sz\<^sub>3)) @ (num\<^sub>4 \<Colon> sz\<^sub>4)\<close>], solve_exp, unfold bv_concat.simps, simp (no_asm) del: dvd_imp_mod_0 mod_less, solve_exps\<close>
  \<bar> \<open>_ \<turnstile> ((num\<^sub>1 \<Colon> sz\<^sub>1) @ (num\<^sub>2 \<Colon> sz\<^sub>2)) @ (num\<^sub>3 \<Colon> sz\<^sub>3) \<leadsto>* _\<close> for num\<^sub>1 num\<^sub>2 num\<^sub>3 sz\<^sub>1 sz\<^sub>2 sz\<^sub>3 \<Rightarrow> \<open>rule REDUCE[of _ _ \<open>((num\<^sub>1 \<Colon> sz\<^sub>1) \<cdot> (num\<^sub>2 \<Colon> sz\<^sub>2)) @ (num\<^sub>3 \<Colon> sz\<^sub>3)\<close>], solve_exp, unfold bv_concat.simps, simp (no_asm) del: dvd_imp_mod_0 mod_less, solve_exps\<close>
  ...
  ; rule? (* attempt to discharge ?x variables *)
)
